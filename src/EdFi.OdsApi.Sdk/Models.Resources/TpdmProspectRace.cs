...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmProspectRace :  IEquatable<TpdmProspectRace>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmProspectRace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmProspectRace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmProspectRace" /> class.
        /// </summary>
        ...
        public TpdmProspectRace(string raceDescriptor = default(string))
        {
            // to ensure "raceDescriptor" is required (not null)
            if (raceDescriptor == null)
            {
                throw new InvalidDataException("raceDescriptor is a required property for TpdmProspectRace and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmProspectRace);
        }

        /// <summary>
        /// Returns true if TpdmProspectRace instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmProspectRace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmProspectRace input)
        {
            if (input == null)
                return false;
