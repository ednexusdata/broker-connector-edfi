...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmApplicantPersonalIdentificationDocument :  IEquatable<TpdmApplicantPersonalIdentificationDocument>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantPersonalIdentificationDocument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantPersonalIdentificationDocument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantPersonalIdentificationDocument" /> class.
        /// </summary>
        ...
        public TpdmApplicantPersonalIdentificationDocument(string identificationDocumentUseDescriptor = default(string), string personalInformationVerificationDescriptor = default(string), string issuerCountryDescriptor = default(string), DateTime? documentExpirationDate = default(DateTime?), string documentTitle = default(string), string issuerDocumentIdentificationCode = default(string), string issuerName = default(string))
        {
            ...
            {
                throw new InvalidDataException("personalInformationVerificationDescriptor is a required property for TpdmApplicantPersonalIdentificationDocument and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmApplicantPersonalIdentificationDocument);
        }

        /// <summary>
        /// Returns true if TpdmApplicantPersonalIdentificationDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantPersonalIdentificationDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantPersonalIdentificationDocument input)
        {
            if (input == null)
                return false;
