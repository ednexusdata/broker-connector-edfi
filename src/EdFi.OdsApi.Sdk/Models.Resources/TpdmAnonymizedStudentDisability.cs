...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmAnonymizedStudentDisability :  IEquatable<TpdmAnonymizedStudentDisability>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmAnonymizedStudentDisability" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmAnonymizedStudentDisability() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmAnonymizedStudentDisability" /> class.
        /// </summary>
        ...
        /// <param name="designations">An unordered collection of anonymizedStudentDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation..</param>
        public TpdmAnonymizedStudentDisability(string disabilityDescriptor = default(string), string disabilityDeterminationSourceTypeDescriptor = default(string), string disabilityDiagnosis = default(string), int? orderOfDisability = default(int?), List<TpdmAnonymizedStudentDisabilityDesignation> designations = default(List<TpdmAnonymizedStudentDisabilityDesignation>))
        {
            // to ensure "disabilityDescriptor" is required (not null)
            if (disabilityDescriptor == null)
            {
                throw new InvalidDataException("disabilityDescriptor is a required property for TpdmAnonymizedStudentDisability and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>An unordered collection of anonymizedStudentDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation.</value>
        [DataMember(Name="designations", EmitDefaultValue=false)]
        public List<TpdmAnonymizedStudentDisabilityDesignation> Designations { get; set; }
        ...
        {
            return this.Equals(input as TpdmAnonymizedStudentDisability);
        }

        /// <summary>
        /// Returns true if TpdmAnonymizedStudentDisability instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmAnonymizedStudentDisability to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmAnonymizedStudentDisability input)
        {
            if (input == null)
                return false;
