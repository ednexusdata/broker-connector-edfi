...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmAnonymizedStudentSectionAssociation :  IEquatable<TpdmAnonymizedStudentSectionAssociation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmAnonymizedStudentSectionAssociation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmAnonymizedStudentSectionAssociation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmAnonymizedStudentSectionAssociation" /> class.
        /// </summary>
        ...
        public TpdmAnonymizedStudentSectionAssociation(string id = default(string), DateTime? beginDate = default(DateTime?), TpdmAnonymizedStudentReference anonymizedStudentReference = default(TpdmAnonymizedStudentReference), EdFiSectionReference sectionReference = default(EdFiSectionReference), DateTime? endDate = default(DateTime?), string etag = default(string))
        {
            // to ensure "beginDate" is required (not null)
            if (beginDate == null)
            {
                throw new InvalidDataException("beginDate is a required property for TpdmAnonymizedStudentSectionAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("anonymizedStudentReference is a required property for TpdmAnonymizedStudentSectionAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sectionReference is a required property for TpdmAnonymizedStudentSectionAssociation and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmAnonymizedStudentSectionAssociation);
        }

        /// <summary>
        /// Returns true if TpdmAnonymizedStudentSectionAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmAnonymizedStudentSectionAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmAnonymizedStudentSectionAssociation input)
        {
            if (input == null)
                return false;
