...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleStaffPet :  IEquatable<SampleStaffPet>
    {
        /// <summary>
        ...
        public SampleStaffPet(string petName = default(string), bool? isFixed = default(bool?))
        {
            ...
            if (petName == null)
            {
                throw new InvalidDataException("petName is a required property for SampleStaffPet and cannot be null");
            }
            else
            {
