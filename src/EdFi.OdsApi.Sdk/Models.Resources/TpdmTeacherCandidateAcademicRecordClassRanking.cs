...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateAcademicRecordClassRanking :  IEquatable<TpdmTeacherCandidateAcademicRecordClassRanking>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateAcademicRecordClassRanking" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateAcademicRecordClassRanking() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateAcademicRecordClassRanking" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidateAcademicRecordClassRanking(int? classRank = default(int?), DateTime? classRankingDate = default(DateTime?), int? percentageRanking = default(int?), int? totalNumberInClass = default(int?))
        {
            // to ensure "classRank" is required (not null)
            if (classRank == null)
            {
                throw new InvalidDataException("classRank is a required property for TpdmTeacherCandidateAcademicRecordClassRanking and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("totalNumberInClass is a required property for TpdmTeacherCandidateAcademicRecordClassRanking and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateAcademicRecordClassRanking);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateAcademicRecordClassRanking instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateAcademicRecordClassRanking to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateAcademicRecordClassRanking input)
        {
            if (input == null)
                return false;
