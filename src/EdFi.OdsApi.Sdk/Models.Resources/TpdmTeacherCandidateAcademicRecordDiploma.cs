...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateAcademicRecordDiploma :  IEquatable<TpdmTeacherCandidateAcademicRecordDiploma>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateAcademicRecordDiploma" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateAcademicRecordDiploma() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateAcademicRecordDiploma" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidateAcademicRecordDiploma(string diplomaTypeDescriptor = default(string), DateTime? diplomaAwardDate = default(DateTime?), string achievementCategoryDescriptor = default(string), string diplomaLevelDescriptor = default(string), string achievementCategorySystem = default(string), string achievementTitle = default(string), string criteria = default(string), string criteriaURL = default(string), bool? cteCompleter = default(bool?), DateTime? diplomaAwardExpiresDate = default(DateTime?), string diplomaDescription = default(string), string evidenceStatement = default(string), string imageURL = default(string), string issuerName = default(string), string issuerOriginURL = default(string))
        {
            ...
            {
                throw new InvalidDataException("diplomaAwardDate is a required property for TpdmTeacherCandidateAcademicRecordDiploma and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateAcademicRecordDiploma);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateAcademicRecordDiploma instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateAcademicRecordDiploma to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateAcademicRecordDiploma input)
        {
            if (input == null)
                return false;
