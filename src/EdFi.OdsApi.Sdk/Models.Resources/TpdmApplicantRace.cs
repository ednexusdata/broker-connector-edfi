...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmApplicantRace :  IEquatable<TpdmApplicantRace>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantRace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantRace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantRace" /> class.
        /// </summary>
        ...
        public TpdmApplicantRace(string raceDescriptor = default(string))
        {
            // to ensure "raceDescriptor" is required (not null)
            if (raceDescriptor == null)
            {
                throw new InvalidDataException("raceDescriptor is a required property for TpdmApplicantRace and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmApplicantRace);
        }

        /// <summary>
        /// Returns true if TpdmApplicantRace instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantRace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantRace input)
        {
            if (input == null)
                return false;
