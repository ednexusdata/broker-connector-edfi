...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmApplicantInternationalAddress :  IEquatable<TpdmApplicantInternationalAddress>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantInternationalAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantInternationalAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantInternationalAddress" /> class.
        /// </summary>
        ...
        public TpdmApplicantInternationalAddress(string addressTypeDescriptor = default(string), string countryDescriptor = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string addressLine4 = default(string), DateTime? beginDate = default(DateTime?), DateTime? endDate = default(DateTime?), string latitude = default(string), string longitude = default(string))
        {
            // to ensure "addressTypeDescriptor" is required (not null)
            if (addressTypeDescriptor == null)
            {
                throw new InvalidDataException("addressTypeDescriptor is a required property for TpdmApplicantInternationalAddress and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("countryDescriptor is a required property for TpdmApplicantInternationalAddress and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("addressLine1 is a required property for TpdmApplicantInternationalAddress and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmApplicantInternationalAddress);
        }

        /// <summary>
        /// Returns true if TpdmApplicantInternationalAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantInternationalAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantInternationalAddress input)
        {
            if (input == null)
                return false;
