...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmProspectDisability :  IEquatable<TpdmProspectDisability>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmProspectDisability" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmProspectDisability() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmProspectDisability" /> class.
        /// </summary>
        ...
        /// <param name="designations">An unordered collection of prospectDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation..</param>
        public TpdmProspectDisability(string disabilityDescriptor = default(string), string disabilityDeterminationSourceTypeDescriptor = default(string), string disabilityDiagnosis = default(string), int? orderOfDisability = default(int?), List<TpdmProspectDisabilityDesignation> designations = default(List<TpdmProspectDisabilityDesignation>))
        {
            // to ensure "disabilityDescriptor" is required (not null)
            if (disabilityDescriptor == null)
            {
                throw new InvalidDataException("disabilityDescriptor is a required property for TpdmProspectDisability and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>An unordered collection of prospectDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation.</value>
        [DataMember(Name="designations", EmitDefaultValue=false)]
        public List<TpdmProspectDisabilityDesignation> Designations { get; set; }
        ...
        {
            return this.Equals(input as TpdmProspectDisability);
        }

        /// <summary>
        /// Returns true if TpdmProspectDisability instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmProspectDisability to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmProspectDisability input)
        {
            if (input == null)
                return false;
