...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateElectronicMail :  IEquatable<TpdmTeacherCandidateElectronicMail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateElectronicMail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateElectronicMail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateElectronicMail" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidateElectronicMail(string electronicMailTypeDescriptor = default(string), string electronicMailAddress = default(string), bool? doNotPublishIndicator = default(bool?), bool? primaryEmailAddressIndicator = default(bool?))
        {
            // to ensure "electronicMailTypeDescriptor" is required (not null)
            if (electronicMailTypeDescriptor == null)
            {
                throw new InvalidDataException("electronicMailTypeDescriptor is a required property for TpdmTeacherCandidateElectronicMail and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("electronicMailAddress is a required property for TpdmTeacherCandidateElectronicMail and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateElectronicMail);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateElectronicMail instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateElectronicMail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateElectronicMail input)
        {
            if (input == null)
                return false;
