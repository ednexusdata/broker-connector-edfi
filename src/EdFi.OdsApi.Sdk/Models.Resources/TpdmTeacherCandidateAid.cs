...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateAid :  IEquatable<TpdmTeacherCandidateAid>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateAid" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateAid() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateAid" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidateAid(string aidTypeDescriptor = default(string), DateTime? beginDate = default(DateTime?), double? aidAmount = default(double?), string aidConditionDescription = default(string), DateTime? endDate = default(DateTime?), bool? pellGrantRecipient = default(bool?))
        {
            // to ensure "aidTypeDescriptor" is required (not null)
            if (aidTypeDescriptor == null)
            {
                throw new InvalidDataException("aidTypeDescriptor is a required property for TpdmTeacherCandidateAid and cannot be null");
            }
            else
            {
            ...
            if (beginDate == null)
            {
                throw new InvalidDataException("beginDate is a required property for TpdmTeacherCandidateAid and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateAid);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateAid instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateAid to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateAid input)
        {
            if (input == null)
                return false;
