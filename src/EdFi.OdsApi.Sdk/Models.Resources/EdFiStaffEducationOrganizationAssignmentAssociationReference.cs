...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiStaffEducationOrganizationAssignmentAssociationReference :  IEquatable<EdFiStaffEducationOrganizationAssignmentAssociationReference>
    {
        /// <summary>
        ...
        public EdFiStaffEducationOrganizationAssignmentAssociationReference(DateTime? beginDate = default(DateTime?), int? educationOrganizationId = default(int?), string staffClassificationDescriptor = default(string), string staffUniqueId = default(string), Link link = default(Link))
        {
            // to ensure "beginDate" is required (not null)
            if (beginDate == null)
            {
                throw new InvalidDataException("beginDate is a required property for EdFiStaffEducationOrganizationAssignmentAssociationReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("educationOrganizationId is a required property for EdFiStaffEducationOrganizationAssignmentAssociationReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("staffClassificationDescriptor is a required property for EdFiStaffEducationOrganizationAssignmentAssociationReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("staffUniqueId is a required property for EdFiStaffEducationOrganizationAssignmentAssociationReference and cannot be null");
            }
            else
            {
