...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmApplicantAid :  IEquatable<TpdmApplicantAid>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantAid" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantAid() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantAid" /> class.
        /// </summary>
        ...
        public TpdmApplicantAid(string aidTypeDescriptor = default(string), DateTime? beginDate = default(DateTime?), double? aidAmount = default(double?), string aidConditionDescription = default(string), DateTime? endDate = default(DateTime?), bool? pellGrantRecipient = default(bool?))
        {
            // to ensure "aidTypeDescriptor" is required (not null)
            if (aidTypeDescriptor == null)
            {
                throw new InvalidDataException("aidTypeDescriptor is a required property for TpdmApplicantAid and cannot be null");
            }
            else
            {
            ...
            if (beginDate == null)
            {
                throw new InvalidDataException("beginDate is a required property for TpdmApplicantAid and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmApplicantAid);
        }

        /// <summary>
        /// Returns true if TpdmApplicantAid instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantAid to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantAid input)
        {
            if (input == null)
                return false;
