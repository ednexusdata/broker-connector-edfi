...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleSchoolCTEProgram :  IEquatable<SampleSchoolCTEProgram>
    {
        /// <summary>
        ...
        public SampleSchoolCTEProgram(string careerPathwayDescriptor = default(string), string cipCode = default(string), bool? cteProgramCompletionIndicator = default(bool?), bool? primaryCTEProgramIndicator = default(bool?))
        {
            ...
            {
                throw new InvalidDataException("careerPathwayDescriptor is a required property for SampleSchoolCTEProgram and cannot be null");
            }
            else
            {
