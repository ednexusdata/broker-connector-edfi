...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleStudentArtProgramAssociationService :  IEquatable<SampleStudentArtProgramAssociationService>
    {
        /// <summary>
        ...
        public SampleStudentArtProgramAssociationService(string serviceDescriptor = default(string), bool? primaryIndicator = default(bool?), DateTime? serviceBeginDate = default(DateTime?), DateTime? serviceEndDate = default(DateTime?))
        {
            ...
            {
                throw new InvalidDataException("serviceDescriptor is a required property for SampleStudentArtProgramAssociationService and cannot be null");
            }
            else
            {
