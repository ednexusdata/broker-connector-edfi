...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmApplicantTelephone :  IEquatable<TpdmApplicantTelephone>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantTelephone" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantTelephone() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantTelephone" /> class.
        /// </summary>
        ...
        public TpdmApplicantTelephone(string telephoneNumberTypeDescriptor = default(string), string telephoneNumber = default(string), bool? doNotPublishIndicator = default(bool?), int? orderOfPriority = default(int?), bool? textMessageCapabilityIndicator = default(bool?))
        {
            // to ensure "telephoneNumberTypeDescriptor" is required (not null)
            if (telephoneNumberTypeDescriptor == null)
            {
                throw new InvalidDataException("telephoneNumberTypeDescriptor is a required property for TpdmApplicantTelephone and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("telephoneNumber is a required property for TpdmApplicantTelephone and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmApplicantTelephone);
        }

        /// <summary>
        /// Returns true if TpdmApplicantTelephone instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantTelephone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantTelephone input)
        {
            if (input == null)
                return false;
