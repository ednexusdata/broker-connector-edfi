...
{
    /// <summary>
    /// SampleParentCTEProgram
    /// </summary>
    [DataContract]
    public partial class SampleParentCTEProgram :  IEquatable<SampleParentCTEProgram>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleParentCTEProgram" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleParentCTEProgram() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleParentCTEProgram" /> class.
        /// </summary>
        ...
        public SampleParentCTEProgram(string careerPathwayDescriptor = default(string), string cipCode = default(string), bool? cteProgramCompletionIndicator = default(bool?), bool? primaryCTEProgramIndicator = default(bool?))
        {
            // to ensure "careerPathwayDescriptor" is required (not null)
            if (careerPathwayDescriptor == null)
            {
                throw new InvalidDataException("careerPathwayDescriptor is a required property for SampleParentCTEProgram and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleParentCTEProgram {\n");
        ...
        {
            return this.Equals(input as SampleParentCTEProgram);
        }

        /// <summary>
        /// Returns true if SampleParentCTEProgram instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleParentCTEProgram to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleParentCTEProgram input)
        {
            if (input == null)
                return false;
