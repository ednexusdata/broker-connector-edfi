...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateStudentGrowthMeasureCourseAssociation :  IEquatable<TpdmTeacherCandidateStudentGrowthMeasureCourseAssociation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateStudentGrowthMeasureCourseAssociation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateStudentGrowthMeasureCourseAssociation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateStudentGrowthMeasureCourseAssociation" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidateStudentGrowthMeasureCourseAssociation(string id = default(string), EdFiCourseReference courseReference = default(EdFiCourseReference), TpdmTeacherCandidateStudentGrowthMeasureReference teacherCandidateStudentGrowthMeasureReference = default(TpdmTeacherCandidateStudentGrowthMeasureReference), DateTime? beginDate = default(DateTime?), DateTime? endDate = default(DateTime?), string etag = default(string))
        {
            // to ensure "courseReference" is required (not null)
            if (courseReference == null)
            {
                throw new InvalidDataException("courseReference is a required property for TpdmTeacherCandidateStudentGrowthMeasureCourseAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("teacherCandidateStudentGrowthMeasureReference is a required property for TpdmTeacherCandidateStudentGrowthMeasureCourseAssociation and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateStudentGrowthMeasureCourseAssociation);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateStudentGrowthMeasureCourseAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateStudentGrowthMeasureCourseAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateStudentGrowthMeasureCourseAssociation input)
        {
            if (input == null)
                return false;
