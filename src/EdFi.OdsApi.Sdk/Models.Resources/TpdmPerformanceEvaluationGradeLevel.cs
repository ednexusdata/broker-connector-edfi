...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmPerformanceEvaluationGradeLevel :  IEquatable<TpdmPerformanceEvaluationGradeLevel>
    {
        /// <summary>
        ...
        public TpdmPerformanceEvaluationGradeLevel(string gradeLevelDescriptor = default(string))
        {
            ...
            {
                throw new InvalidDataException("gradeLevelDescriptor is a required property for TpdmPerformanceEvaluationGradeLevel and cannot be null");
            }
            else
            {
