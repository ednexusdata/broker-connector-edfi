...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherPreparationProviderProgramReference :  IEquatable<TpdmTeacherPreparationProviderProgramReference>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherPreparationProviderProgramReference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherPreparationProviderProgramReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherPreparationProviderProgramReference" /> class.
        /// </summary>
        ...
        public TpdmTeacherPreparationProviderProgramReference(int? educationOrganizationId = default(int?), string programName = default(string), string programTypeDescriptor = default(string), Link link = default(Link))
        {
            // to ensure "educationOrganizationId" is required (not null)
            if (educationOrganizationId == null)
            {
                throw new InvalidDataException("educationOrganizationId is a required property for TpdmTeacherPreparationProviderProgramReference and cannot be null");
            }
            else
            {
            ...
            if (programName == null)
            {
                throw new InvalidDataException("programName is a required property for TpdmTeacherPreparationProviderProgramReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("programTypeDescriptor is a required property for TpdmTeacherPreparationProviderProgramReference and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherPreparationProviderProgramReference);
        }

        /// <summary>
        /// Returns true if TpdmTeacherPreparationProviderProgramReference instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherPreparationProviderProgramReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherPreparationProviderProgramReference input)
        {
            if (input == null)
                return false;
