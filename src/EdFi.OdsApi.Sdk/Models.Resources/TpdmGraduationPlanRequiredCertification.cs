...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmGraduationPlanRequiredCertification :  IEquatable<TpdmGraduationPlanRequiredCertification>
    {
        /// <summary>
        ...
        public TpdmGraduationPlanRequiredCertification(string certificationTitle = default(string), string certificationRouteDescriptor = default(string), TpdmCertificationReference certificationReference = default(TpdmCertificationReference))
        {
            ...
            {
                throw new InvalidDataException("certificationTitle is a required property for TpdmGraduationPlanRequiredCertification and cannot be null");
            }
            else
            {
