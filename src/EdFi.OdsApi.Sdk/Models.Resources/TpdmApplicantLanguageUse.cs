...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmApplicantLanguageUse :  IEquatable<TpdmApplicantLanguageUse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantLanguageUse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantLanguageUse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantLanguageUse" /> class.
        /// </summary>
        ...
        public TpdmApplicantLanguageUse(string languageUseDescriptor = default(string))
        {
            // to ensure "languageUseDescriptor" is required (not null)
            if (languageUseDescriptor == null)
            {
                throw new InvalidDataException("languageUseDescriptor is a required property for TpdmApplicantLanguageUse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmApplicantLanguageUse);
        }

        /// <summary>
        /// Returns true if TpdmApplicantLanguageUse instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantLanguageUse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantLanguageUse input)
        {
            if (input == null)
                return false;
