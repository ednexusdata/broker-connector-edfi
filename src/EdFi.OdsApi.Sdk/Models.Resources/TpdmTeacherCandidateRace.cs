...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateRace :  IEquatable<TpdmTeacherCandidateRace>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateRace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateRace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateRace" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidateRace(string raceDescriptor = default(string))
        {
            // to ensure "raceDescriptor" is required (not null)
            if (raceDescriptor == null)
            {
                throw new InvalidDataException("raceDescriptor is a required property for TpdmTeacherCandidateRace and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateRace);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateRace instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateRace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateRace input)
        {
            if (input == null)
                return false;
