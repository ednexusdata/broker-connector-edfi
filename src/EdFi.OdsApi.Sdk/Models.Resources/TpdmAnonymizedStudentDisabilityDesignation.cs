...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmAnonymizedStudentDisabilityDesignation :  IEquatable<TpdmAnonymizedStudentDisabilityDesignation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmAnonymizedStudentDisabilityDesignation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmAnonymizedStudentDisabilityDesignation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmAnonymizedStudentDisabilityDesignation" /> class.
        /// </summary>
        ...
        public TpdmAnonymizedStudentDisabilityDesignation(string disabilityDesignationDescriptor = default(string))
        {
            // to ensure "disabilityDesignationDescriptor" is required (not null)
            if (disabilityDesignationDescriptor == null)
            {
                throw new InvalidDataException("disabilityDesignationDescriptor is a required property for TpdmAnonymizedStudentDisabilityDesignation and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmAnonymizedStudentDisabilityDesignation);
        }

        /// <summary>
        /// Returns true if TpdmAnonymizedStudentDisabilityDesignation instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmAnonymizedStudentDisabilityDesignation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmAnonymizedStudentDisabilityDesignation input)
        {
            if (input == null)
                return false;
