...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmCompleterAsStaffAssociation :  IEquatable<TpdmCompleterAsStaffAssociation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCompleterAsStaffAssociation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmCompleterAsStaffAssociation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCompleterAsStaffAssociation" /> class.
        /// </summary>
        ...
        public TpdmCompleterAsStaffAssociation(string id = default(string), EdFiStaffReference staffReference = default(EdFiStaffReference), TpdmTeacherCandidateReference teacherCandidateReference = default(TpdmTeacherCandidateReference), string etag = default(string))
        {
            // to ensure "staffReference" is required (not null)
            if (staffReference == null)
            {
                throw new InvalidDataException("staffReference is a required property for TpdmCompleterAsStaffAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("teacherCandidateReference is a required property for TpdmCompleterAsStaffAssociation and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmCompleterAsStaffAssociation);
        }

        /// <summary>
        /// Returns true if TpdmCompleterAsStaffAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmCompleterAsStaffAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmCompleterAsStaffAssociation input)
        {
            if (input == null)
                return false;
