...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateDisability :  IEquatable<TpdmTeacherCandidateDisability>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateDisability" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateDisability() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateDisability" /> class.
        /// </summary>
        ...
        /// <param name="designations">An unordered collection of teacherCandidateDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation..</param>
        public TpdmTeacherCandidateDisability(string disabilityDescriptor = default(string), string disabilityDeterminationSourceTypeDescriptor = default(string), string disabilityDiagnosis = default(string), int? orderOfDisability = default(int?), List<TpdmTeacherCandidateDisabilityDesignation> designations = default(List<TpdmTeacherCandidateDisabilityDesignation>))
        {
            // to ensure "disabilityDescriptor" is required (not null)
            if (disabilityDescriptor == null)
            {
                throw new InvalidDataException("disabilityDescriptor is a required property for TpdmTeacherCandidateDisability and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>An unordered collection of teacherCandidateDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation.</value>
        [DataMember(Name="designations", EmitDefaultValue=false)]
        public List<TpdmTeacherCandidateDisabilityDesignation> Designations { get; set; }
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateDisability);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateDisability instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateDisability to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateDisability input)
        {
            if (input == null)
                return false;
