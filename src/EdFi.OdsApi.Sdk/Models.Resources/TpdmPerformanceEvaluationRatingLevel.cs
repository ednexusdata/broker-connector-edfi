...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmPerformanceEvaluationRatingLevel :  IEquatable<TpdmPerformanceEvaluationRatingLevel>
    {
        /// <summary>
        ...
        public TpdmPerformanceEvaluationRatingLevel(string evaluationRatingLevelDescriptor = default(string), double? maxRating = default(double?), double? minRating = default(double?))
        {
            ...
            {
                throw new InvalidDataException("evaluationRatingLevelDescriptor is a required property for TpdmPerformanceEvaluationRatingLevel and cannot be null");
            }
            else
            {
