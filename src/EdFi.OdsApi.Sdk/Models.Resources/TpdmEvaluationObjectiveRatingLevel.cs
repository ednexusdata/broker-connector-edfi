...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmEvaluationObjectiveRatingLevel :  IEquatable<TpdmEvaluationObjectiveRatingLevel>
    {
        /// <summary>
        ...
        public TpdmEvaluationObjectiveRatingLevel(string evaluationRatingLevelDescriptor = default(string), double? maxRating = default(double?), double? minRating = default(double?))
        {
            ...
            {
                throw new InvalidDataException("evaluationRatingLevelDescriptor is a required property for TpdmEvaluationObjectiveRatingLevel and cannot be null");
            }
            else
            {
