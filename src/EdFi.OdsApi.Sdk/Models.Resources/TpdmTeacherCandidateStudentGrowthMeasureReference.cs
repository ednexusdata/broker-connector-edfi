...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateStudentGrowthMeasureReference :  IEquatable<TpdmTeacherCandidateStudentGrowthMeasureReference>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateStudentGrowthMeasureReference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateStudentGrowthMeasureReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateStudentGrowthMeasureReference" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidateStudentGrowthMeasureReference(DateTime? factAsOfDate = default(DateTime?), int? schoolYear = default(int?), string teacherCandidateIdentifier = default(string), string teacherCandidateStudentGrowthMeasureIdentifier = default(string), Link link = default(Link))
        {
            // to ensure "factAsOfDate" is required (not null)
            if (factAsOfDate == null)
            {
                throw new InvalidDataException("factAsOfDate is a required property for TpdmTeacherCandidateStudentGrowthMeasureReference and cannot be null");
            }
            else
            {
            ...
            if (schoolYear == null)
            {
                throw new InvalidDataException("schoolYear is a required property for TpdmTeacherCandidateStudentGrowthMeasureReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("teacherCandidateIdentifier is a required property for TpdmTeacherCandidateStudentGrowthMeasureReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("teacherCandidateStudentGrowthMeasureIdentifier is a required property for TpdmTeacherCandidateStudentGrowthMeasureReference and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateStudentGrowthMeasureReference);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateStudentGrowthMeasureReference instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateStudentGrowthMeasureReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateStudentGrowthMeasureReference input)
        {
            if (input == null)
                return false;
