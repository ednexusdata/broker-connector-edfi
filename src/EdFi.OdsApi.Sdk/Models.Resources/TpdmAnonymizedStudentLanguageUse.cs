...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmAnonymizedStudentLanguageUse :  IEquatable<TpdmAnonymizedStudentLanguageUse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmAnonymizedStudentLanguageUse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmAnonymizedStudentLanguageUse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmAnonymizedStudentLanguageUse" /> class.
        /// </summary>
        ...
        public TpdmAnonymizedStudentLanguageUse(string languageUseDescriptor = default(string))
        {
            // to ensure "languageUseDescriptor" is required (not null)
            if (languageUseDescriptor == null)
            {
                throw new InvalidDataException("languageUseDescriptor is a required property for TpdmAnonymizedStudentLanguageUse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmAnonymizedStudentLanguageUse);
        }

        /// <summary>
        /// Returns true if TpdmAnonymizedStudentLanguageUse instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmAnonymizedStudentLanguageUse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmAnonymizedStudentLanguageUse input)
        {
            if (input == null)
                return false;
