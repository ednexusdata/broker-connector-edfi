...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateOtherName :  IEquatable<TpdmTeacherCandidateOtherName>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateOtherName" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateOtherName() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateOtherName" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidateOtherName(string otherNameTypeDescriptor = default(string), string firstName = default(string), string generationCodeSuffix = default(string), string lastSurname = default(string), string middleName = default(string), string personalTitlePrefix = default(string))
        {
            // to ensure "otherNameTypeDescriptor" is required (not null)
            if (otherNameTypeDescriptor == null)
            {
                throw new InvalidDataException("otherNameTypeDescriptor is a required property for TpdmTeacherCandidateOtherName and cannot be null");
            }
            else
            {
            ...
            if (firstName == null)
            {
                throw new InvalidDataException("firstName is a required property for TpdmTeacherCandidateOtherName and cannot be null");
            }
            else
            {
            ...
            if (lastSurname == null)
            {
                throw new InvalidDataException("lastSurname is a required property for TpdmTeacherCandidateOtherName and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateOtherName);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateOtherName instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateOtherName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateOtherName input)
        {
            if (input == null)
                return false;
