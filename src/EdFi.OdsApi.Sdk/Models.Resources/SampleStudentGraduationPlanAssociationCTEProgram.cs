...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleStudentGraduationPlanAssociationCTEProgram :  IEquatable<SampleStudentGraduationPlanAssociationCTEProgram>
    {
        /// <summary>
        ...
        public SampleStudentGraduationPlanAssociationCTEProgram(string careerPathwayDescriptor = default(string), string cipCode = default(string), bool? cteProgramCompletionIndicator = default(bool?), bool? primaryCTEProgramIndicator = default(bool?))
        {
            ...
            {
                throw new InvalidDataException("careerPathwayDescriptor is a required property for SampleStudentGraduationPlanAssociationCTEProgram and cannot be null");
            }
            else
            {
