...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmStaffApplicantAssociation :  IEquatable<TpdmStaffApplicantAssociation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmStaffApplicantAssociation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmStaffApplicantAssociation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmStaffApplicantAssociation" /> class.
        /// </summary>
        ...
        public TpdmStaffApplicantAssociation(string id = default(string), TpdmApplicantReference applicantReference = default(TpdmApplicantReference), EdFiStaffReference staffReference = default(EdFiStaffReference), string etag = default(string))
        {
            // to ensure "applicantReference" is required (not null)
            if (applicantReference == null)
            {
                throw new InvalidDataException("applicantReference is a required property for TpdmStaffApplicantAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("staffReference is a required property for TpdmStaffApplicantAssociation and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmStaffApplicantAssociation);
        }

        /// <summary>
        /// Returns true if TpdmStaffApplicantAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmStaffApplicantAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmStaffApplicantAssociation input)
        {
            if (input == null)
                return false;
