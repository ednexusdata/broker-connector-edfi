...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmApplicantDisability :  IEquatable<TpdmApplicantDisability>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantDisability" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantDisability() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantDisability" /> class.
        /// </summary>
        ...
        /// <param name="designations">An unordered collection of applicantDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation..</param>
        public TpdmApplicantDisability(string disabilityDescriptor = default(string), string disabilityDeterminationSourceTypeDescriptor = default(string), string disabilityDiagnosis = default(string), int? orderOfDisability = default(int?), List<TpdmApplicantDisabilityDesignation> designations = default(List<TpdmApplicantDisabilityDesignation>))
        {
            // to ensure "disabilityDescriptor" is required (not null)
            if (disabilityDescriptor == null)
            {
                throw new InvalidDataException("disabilityDescriptor is a required property for TpdmApplicantDisability and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>An unordered collection of applicantDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation.</value>
        [DataMember(Name="designations", EmitDefaultValue=false)]
        public List<TpdmApplicantDisabilityDesignation> Designations { get; set; }
        ...
        {
            return this.Equals(input as TpdmApplicantDisability);
        }

        /// <summary>
        /// Returns true if TpdmApplicantDisability instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantDisability to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantDisability input)
        {
            if (input == null)
                return false;
