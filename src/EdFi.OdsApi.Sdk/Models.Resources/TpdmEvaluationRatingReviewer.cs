...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmEvaluationRatingReviewer :  IEquatable<TpdmEvaluationRatingReviewer>
    {
        /// <summary>
        ...
        public TpdmEvaluationRatingReviewer(string firstName = default(string), string lastSurname = default(string), EdFiPersonReference reviewerPersonReference = default(EdFiPersonReference), TpdmEvaluationRatingReviewerReceivedTraining receivedTraining = default(TpdmEvaluationRatingReviewerReceivedTraining))
        {
            ...
            if (firstName == null)
            {
                throw new InvalidDataException("firstName is a required property for TpdmEvaluationRatingReviewer and cannot be null");
            }
            else
            {
            ...
            if (lastSurname == null)
            {
                throw new InvalidDataException("lastSurname is a required property for TpdmEvaluationRatingReviewer and cannot be null");
            }
            else
            {
