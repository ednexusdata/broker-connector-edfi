...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidatePersonalIdentificationDocument :  IEquatable<TpdmTeacherCandidatePersonalIdentificationDocument>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidatePersonalIdentificationDocument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidatePersonalIdentificationDocument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidatePersonalIdentificationDocument" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidatePersonalIdentificationDocument(string identificationDocumentUseDescriptor = default(string), string personalInformationVerificationDescriptor = default(string), string issuerCountryDescriptor = default(string), DateTime? documentExpirationDate = default(DateTime?), string documentTitle = default(string), string issuerDocumentIdentificationCode = default(string), string issuerName = default(string))
        {
            ...
            {
                throw new InvalidDataException("personalInformationVerificationDescriptor is a required property for TpdmTeacherCandidatePersonalIdentificationDocument and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidatePersonalIdentificationDocument);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidatePersonalIdentificationDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidatePersonalIdentificationDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidatePersonalIdentificationDocument input)
        {
            if (input == null)
                return false;
