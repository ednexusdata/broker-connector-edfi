...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmAnonymizedStudentAssessmentPerformanceLevel :  IEquatable<TpdmAnonymizedStudentAssessmentPerformanceLevel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmAnonymizedStudentAssessmentPerformanceLevel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmAnonymizedStudentAssessmentPerformanceLevel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmAnonymizedStudentAssessmentPerformanceLevel" /> class.
        /// </summary>
        ...
        public TpdmAnonymizedStudentAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor = default(string), string performanceLevelDescriptor = default(string), bool? performanceLevelMet = default(bool?))
        {
            // to ensure "assessmentReportingMethodDescriptor" is required (not null)
            if (assessmentReportingMethodDescriptor == null)
            {
                throw new InvalidDataException("assessmentReportingMethodDescriptor is a required property for TpdmAnonymizedStudentAssessmentPerformanceLevel and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("performanceLevelDescriptor is a required property for TpdmAnonymizedStudentAssessmentPerformanceLevel and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("performanceLevelMet is a required property for TpdmAnonymizedStudentAssessmentPerformanceLevel and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmAnonymizedStudentAssessmentPerformanceLevel);
        }

        /// <summary>
        /// Returns true if TpdmAnonymizedStudentAssessmentPerformanceLevel instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmAnonymizedStudentAssessmentPerformanceLevel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmAnonymizedStudentAssessmentPerformanceLevel input)
        {
            if (input == null)
                return false;
