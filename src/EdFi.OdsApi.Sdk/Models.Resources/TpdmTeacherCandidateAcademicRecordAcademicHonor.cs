...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateAcademicRecordAcademicHonor :  IEquatable<TpdmTeacherCandidateAcademicRecordAcademicHonor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateAcademicRecordAcademicHonor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateAcademicRecordAcademicHonor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateAcademicRecordAcademicHonor" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidateAcademicRecordAcademicHonor(string academicHonorCategoryDescriptor = default(string), string honorDescription = default(string), string achievementCategoryDescriptor = default(string), string achievementCategorySystem = default(string), string achievementTitle = default(string), string criteria = default(string), string criteriaURL = default(string), string evidenceStatement = default(string), DateTime? honorAwardDate = default(DateTime?), DateTime? honorAwardExpiresDate = default(DateTime?), string imageURL = default(string), string issuerName = default(string), string issuerOriginURL = default(string))
        {
            ...
            {
                throw new InvalidDataException("honorDescription is a required property for TpdmTeacherCandidateAcademicRecordAcademicHonor and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateAcademicRecordAcademicHonor);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateAcademicRecordAcademicHonor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateAcademicRecordAcademicHonor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateAcademicRecordAcademicHonor input)
        {
            if (input == null)
                return false;
