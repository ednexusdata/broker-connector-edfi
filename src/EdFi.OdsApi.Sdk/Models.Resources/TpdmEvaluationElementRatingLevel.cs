...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmEvaluationElementRatingLevel :  IEquatable<TpdmEvaluationElementRatingLevel>
    {
        /// <summary>
        ...
        public TpdmEvaluationElementRatingLevel(string evaluationRatingLevelDescriptor = default(string), double? maxRating = default(double?), double? minRating = default(double?))
        {
            ...
            {
                throw new InvalidDataException("evaluationRatingLevelDescriptor is a required property for TpdmEvaluationElementRatingLevel and cannot be null");
            }
            else
            {
