...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmApplicantCharacteristic :  IEquatable<TpdmApplicantCharacteristic>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantCharacteristic" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantCharacteristic() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantCharacteristic" /> class.
        /// </summary>
        ...
        public TpdmApplicantCharacteristic(string studentCharacteristicDescriptor = default(string), DateTime? beginDate = default(DateTime?), string designatedBy = default(string), DateTime? endDate = default(DateTime?))
        {
            // to ensure "studentCharacteristicDescriptor" is required (not null)
            if (studentCharacteristicDescriptor == null)
            {
                throw new InvalidDataException("studentCharacteristicDescriptor is a required property for TpdmApplicantCharacteristic and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmApplicantCharacteristic);
        }

        /// <summary>
        /// Returns true if TpdmApplicantCharacteristic instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantCharacteristic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantCharacteristic input)
        {
            if (input == null)
                return false;
