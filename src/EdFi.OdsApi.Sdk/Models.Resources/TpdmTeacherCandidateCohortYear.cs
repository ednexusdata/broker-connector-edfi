...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateCohortYear :  IEquatable<TpdmTeacherCandidateCohortYear>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateCohortYear" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateCohortYear() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateCohortYear" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidateCohortYear(string cohortYearTypeDescriptor = default(string), EdFiSchoolYearTypeReference schoolYearTypeReference = default(EdFiSchoolYearTypeReference))
        {
            // to ensure "cohortYearTypeDescriptor" is required (not null)
            if (cohortYearTypeDescriptor == null)
            {
                throw new InvalidDataException("cohortYearTypeDescriptor is a required property for TpdmTeacherCandidateCohortYear and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("schoolYearTypeReference is a required property for TpdmTeacherCandidateCohortYear and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateCohortYear);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateCohortYear instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateCohortYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateCohortYear input)
        {
            if (input == null)
                return false;
