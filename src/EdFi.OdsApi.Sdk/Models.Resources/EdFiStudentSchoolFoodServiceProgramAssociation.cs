...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiStudentSchoolFoodServiceProgramAssociation :  IEquatable<EdFiStudentSchoolFoodServiceProgramAssociation>
    {
        /// <summary>
        ...
        public EdFiStudentSchoolFoodServiceProgramAssociation(string id = default(string), DateTime? beginDate = default(DateTime?), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference programReference = default(EdFiProgramReference), EdFiStudentReference studentReference = default(EdFiStudentReference), bool? directCertification = default(bool?), DateTime? endDate = default(DateTime?), EdFiGeneralStudentProgramAssociationParticipationStatus participationStatus = default(EdFiGeneralStudentProgramAssociationParticipationStatus), string reasonExitedDescriptor = default(string), List<EdFiStudentSchoolFoodServiceProgramAssociationSchoolFoodServiceProgramService> schoolFoodServiceProgramServices = default(List<EdFiStudentSchoolFoodServiceProgramAssociationSchoolFoodServiceProgramService>), bool? servedOutsideOfRegularSession = default(bool?), string etag = default(string))
        {
