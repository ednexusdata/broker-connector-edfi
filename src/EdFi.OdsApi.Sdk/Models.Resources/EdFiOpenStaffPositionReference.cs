...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdFiOpenStaffPositionReference :  IEquatable<EdFiOpenStaffPositionReference>
    {
        /// <summary>
        ...
        public EdFiOpenStaffPositionReference(int? educationOrganizationId = default(int?), string requisitionNumber = default(string), Link link = default(Link))
        {
            ...
            {
                throw new InvalidDataException("educationOrganizationId is a required property for EdFiOpenStaffPositionReference and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("requisitionNumber is a required property for EdFiOpenStaffPositionReference and cannot be null");
            }
            else
            {
