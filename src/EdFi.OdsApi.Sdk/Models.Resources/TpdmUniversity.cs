...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmUniversity :  IEquatable<TpdmUniversity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmUniversity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmUniversity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmUniversity" /> class.
        /// </summary>
        ...
        public TpdmUniversity(string id = default(string), List<EdFiEducationOrganizationCategory> categories = default(List<EdFiEducationOrganizationCategory>), int? universityId = default(int?), EdFiSchoolReference schoolReference = default(EdFiSchoolReference), List<EdFiEducationOrganizationAddress> addresses = default(List<EdFiEducationOrganizationAddress>), string federalLocaleCodeDescriptor = default(string), List<EdFiEducationOrganizationIdentificationCode> identificationCodes = default(List<EdFiEducationOrganizationIdentificationCode>), List<EdFiEducationOrganizationIndicator> indicators = default(List<EdFiEducationOrganizationIndicator>), List<EdFiEducationOrganizationInstitutionTelephone> institutionTelephones = default(List<EdFiEducationOrganizationInstitutionTelephone>), List<EdFiEducationOrganizationInternationalAddress> internationalAddresses = default(List<EdFiEducationOrganizationInternationalAddress>), string nameOfInstitution = default(string), string operationalStatusDescriptor = default(string), string shortNameOfInstitution = default(string), string webSite = default(string), string etag = default(string))
        {
            // to ensure "categories" is required (not null)
            if (categories == null)
            {
                throw new InvalidDataException("categories is a required property for TpdmUniversity and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("universityId is a required property for TpdmUniversity and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("nameOfInstitution is a required property for TpdmUniversity and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmUniversity);
        }

        /// <summary>
        /// Returns true if TpdmUniversity instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmUniversity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmUniversity input)
        {
            if (input == null)
                return false;
