...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateAddress :  IEquatable<TpdmTeacherCandidateAddress>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateAddress" /> class.
        /// </summary>
        ...
        /// <param name="periods">An unordered collection of teacherCandidateAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address..</param>
        public TpdmTeacherCandidateAddress(string addressTypeDescriptor = default(string), string stateAbbreviationDescriptor = default(string), string city = default(string), string postalCode = default(string), string streetNumberName = default(string), string localeDescriptor = default(string), string apartmentRoomSuiteNumber = default(string), string buildingSiteNumber = default(string), string congressionalDistrict = default(string), string countyFIPSCode = default(string), bool? doNotPublishIndicator = default(bool?), string latitude = default(string), string longitude = default(string), string nameOfCounty = default(string), List<TpdmTeacherCandidateAddressPeriod> periods = default(List<TpdmTeacherCandidateAddressPeriod>))
        {
            // to ensure "addressTypeDescriptor" is required (not null)
            if (addressTypeDescriptor == null)
            {
                throw new InvalidDataException("addressTypeDescriptor is a required property for TpdmTeacherCandidateAddress and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("stateAbbreviationDescriptor is a required property for TpdmTeacherCandidateAddress and cannot be null");
            }
            else
            {
            ...
            if (city == null)
            {
                throw new InvalidDataException("city is a required property for TpdmTeacherCandidateAddress and cannot be null");
            }
            else
            {
                this.City = city;
            ...
            if (postalCode == null)
            {
                throw new InvalidDataException("postalCode is a required property for TpdmTeacherCandidateAddress and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("streetNumberName is a required property for TpdmTeacherCandidateAddress and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>An unordered collection of teacherCandidateAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.</value>
        [DataMember(Name="periods", EmitDefaultValue=false)]
        public List<TpdmTeacherCandidateAddressPeriod> Periods { get; set; }
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateAddress);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateAddress input)
        {
            if (input == null)
                return false;
