...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateIdentificationDocument :  IEquatable<TpdmTeacherCandidateIdentificationDocument>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateIdentificationDocument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateIdentificationDocument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateIdentificationDocument" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidateIdentificationDocument(string identificationDocumentUseDescriptor = default(string), string personalInformationVerificationDescriptor = default(string), string issuerCountryDescriptor = default(string), DateTime? documentExpirationDate = default(DateTime?), string documentTitle = default(string), string issuerDocumentIdentificationCode = default(string), string issuerName = default(string))
        {
            ...
            {
                throw new InvalidDataException("personalInformationVerificationDescriptor is a required property for TpdmTeacherCandidateIdentificationDocument and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateIdentificationDocument);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateIdentificationDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateIdentificationDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateIdentificationDocument input)
        {
            if (input == null)
                return false;
