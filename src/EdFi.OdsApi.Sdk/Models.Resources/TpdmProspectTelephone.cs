...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmProspectTelephone :  IEquatable<TpdmProspectTelephone>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmProspectTelephone" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmProspectTelephone() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmProspectTelephone" /> class.
        /// </summary>
        ...
        public TpdmProspectTelephone(string telephoneNumberTypeDescriptor = default(string), string telephoneNumber = default(string), bool? doNotPublishIndicator = default(bool?), int? orderOfPriority = default(int?), bool? textMessageCapabilityIndicator = default(bool?))
        {
            // to ensure "telephoneNumberTypeDescriptor" is required (not null)
            if (telephoneNumberTypeDescriptor == null)
            {
                throw new InvalidDataException("telephoneNumberTypeDescriptor is a required property for TpdmProspectTelephone and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("telephoneNumber is a required property for TpdmProspectTelephone and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmProspectTelephone);
        }

        /// <summary>
        /// Returns true if TpdmProspectTelephone instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmProspectTelephone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmProspectTelephone input)
        {
            if (input == null)
                return false;
