...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmApplicantDisabilityDesignation :  IEquatable<TpdmApplicantDisabilityDesignation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantDisabilityDesignation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantDisabilityDesignation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantDisabilityDesignation" /> class.
        /// </summary>
        ...
        public TpdmApplicantDisabilityDesignation(string disabilityDesignationDescriptor = default(string))
        {
            // to ensure "disabilityDesignationDescriptor" is required (not null)
            if (disabilityDesignationDescriptor == null)
            {
                throw new InvalidDataException("disabilityDesignationDescriptor is a required property for TpdmApplicantDisabilityDesignation and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmApplicantDisabilityDesignation);
        }

        /// <summary>
        /// Returns true if TpdmApplicantDisabilityDesignation instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantDisabilityDesignation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantDisabilityDesignation input)
        {
            if (input == null)
                return false;
