...
{
    /// <summary>
    /// SampleStudentParentAssociationTelephone
    /// </summary>
    [DataContract]
    public partial class SampleStudentParentAssociationTelephone :  IEquatable<SampleStudentParentAssociationTelephone>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleStudentParentAssociationTelephone" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleStudentParentAssociationTelephone() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleStudentParentAssociationTelephone" /> class.
        /// </summary>
        ...
        public SampleStudentParentAssociationTelephone(string telephoneNumberTypeDescriptor = default(string), bool? doNotPublishIndicator = default(bool?), int? orderOfPriority = default(int?), string telephoneNumber = default(string), bool? textMessageCapabilityIndicator = default(bool?))
        {
            // to ensure "telephoneNumberTypeDescriptor" is required (not null)
            if (telephoneNumberTypeDescriptor == null)
            {
                throw new InvalidDataException("telephoneNumberTypeDescriptor is a required property for SampleStudentParentAssociationTelephone and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("telephoneNumber is a required property for SampleStudentParentAssociationTelephone and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleStudentParentAssociationTelephone {\n");
        ...
        {
            return this.Equals(input as SampleStudentParentAssociationTelephone);
        }

        /// <summary>
        /// Returns true if SampleStudentParentAssociationTelephone instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleStudentParentAssociationTelephone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleStudentParentAssociationTelephone input)
        {
            if (input == null)
                return false;
