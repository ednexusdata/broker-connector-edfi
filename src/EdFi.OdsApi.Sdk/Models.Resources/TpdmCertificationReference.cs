...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmCertificationReference :  IEquatable<TpdmCertificationReference>
    {
        /// <summary>
        ...
        public TpdmCertificationReference(string certificationIdentifier = default(string), string _namespace = default(string), Link link = default(Link))
        {
            ...
            {
                throw new InvalidDataException("certificationIdentifier is a required property for TpdmCertificationReference and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmCertificationReference and cannot be null");
            }
            else
            {
