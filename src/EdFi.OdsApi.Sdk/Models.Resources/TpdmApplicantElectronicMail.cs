...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmApplicantElectronicMail :  IEquatable<TpdmApplicantElectronicMail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantElectronicMail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantElectronicMail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantElectronicMail" /> class.
        /// </summary>
        ...
        public TpdmApplicantElectronicMail(string electronicMailTypeDescriptor = default(string), string electronicMailAddress = default(string), bool? doNotPublishIndicator = default(bool?), bool? primaryEmailAddressIndicator = default(bool?))
        {
            // to ensure "electronicMailTypeDescriptor" is required (not null)
            if (electronicMailTypeDescriptor == null)
            {
                throw new InvalidDataException("electronicMailTypeDescriptor is a required property for TpdmApplicantElectronicMail and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("electronicMailAddress is a required property for TpdmApplicantElectronicMail and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmApplicantElectronicMail);
        }

        /// <summary>
        /// Returns true if TpdmApplicantElectronicMail instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantElectronicMail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantElectronicMail input)
        {
            if (input == null)
                return false;
