...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmStaffBackgroundCheck :  IEquatable<TpdmStaffBackgroundCheck>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmStaffBackgroundCheck" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmStaffBackgroundCheck() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmStaffBackgroundCheck" /> class.
        /// </summary>
        ...
        public TpdmStaffBackgroundCheck(string backgroundCheckTypeDescriptor = default(string), string backgroundCheckStatusDescriptor = default(string), DateTime? backgroundCheckCompletedDate = default(DateTime?), DateTime? backgroundCheckRequestedDate = default(DateTime?), bool? fingerprint = default(bool?))
        {
            // to ensure "backgroundCheckTypeDescriptor" is required (not null)
            if (backgroundCheckTypeDescriptor == null)
            {
                throw new InvalidDataException("backgroundCheckTypeDescriptor is a required property for TpdmStaffBackgroundCheck and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("backgroundCheckRequestedDate is a required property for TpdmStaffBackgroundCheck and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmStaffBackgroundCheck);
        }

        /// <summary>
        /// Returns true if TpdmStaffBackgroundCheck instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmStaffBackgroundCheck to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmStaffBackgroundCheck input)
        {
            if (input == null)
                return false;
