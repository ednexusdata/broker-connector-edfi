...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleStudentEducationOrganizationAssociationStudentCharacteristicStudentNeed :  IEquatable<SampleStudentEducationOrganizationAssociationStudentCharacteristicStudentNeed>
    {
        /// <summary>
        ...
        public SampleStudentEducationOrganizationAssociationStudentCharacteristicStudentNeed(DateTime? beginDate = default(DateTime?), DateTime? endDate = default(DateTime?), bool? primaryStudentNeedIndicator = default(bool?))
        {
            ...
            if (beginDate == null)
            {
                throw new InvalidDataException("beginDate is a required property for SampleStudentEducationOrganizationAssociationStudentCharacteristicStudentNeed and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="primaryStudentNeedIndicator", EmitDefaultValue=false)]
