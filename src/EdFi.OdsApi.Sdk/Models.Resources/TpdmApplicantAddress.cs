...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmApplicantAddress :  IEquatable<TpdmApplicantAddress>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantAddress" /> class.
        /// </summary>
        ...
        /// <param name="periods">An unordered collection of applicantAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address..</param>
        public TpdmApplicantAddress(string addressTypeDescriptor = default(string), string stateAbbreviationDescriptor = default(string), string city = default(string), string postalCode = default(string), string streetNumberName = default(string), string localeDescriptor = default(string), string apartmentRoomSuiteNumber = default(string), string buildingSiteNumber = default(string), string congressionalDistrict = default(string), string countyFIPSCode = default(string), bool? doNotPublishIndicator = default(bool?), string latitude = default(string), string longitude = default(string), string nameOfCounty = default(string), List<TpdmApplicantAddressPeriod> periods = default(List<TpdmApplicantAddressPeriod>))
        {
            // to ensure "addressTypeDescriptor" is required (not null)
            if (addressTypeDescriptor == null)
            {
                throw new InvalidDataException("addressTypeDescriptor is a required property for TpdmApplicantAddress and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("stateAbbreviationDescriptor is a required property for TpdmApplicantAddress and cannot be null");
            }
            else
            {
            ...
            if (city == null)
            {
                throw new InvalidDataException("city is a required property for TpdmApplicantAddress and cannot be null");
            }
            else
            {
                this.City = city;
            ...
            if (postalCode == null)
            {
                throw new InvalidDataException("postalCode is a required property for TpdmApplicantAddress and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("streetNumberName is a required property for TpdmApplicantAddress and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>An unordered collection of applicantAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.</value>
        [DataMember(Name="periods", EmitDefaultValue=false)]
        public List<TpdmApplicantAddressPeriod> Periods { get; set; }
        ...
        {
            return this.Equals(input as TpdmApplicantAddress);
        }

        /// <summary>
        /// Returns true if TpdmApplicantAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantAddress input)
        {
            if (input == null)
                return false;
