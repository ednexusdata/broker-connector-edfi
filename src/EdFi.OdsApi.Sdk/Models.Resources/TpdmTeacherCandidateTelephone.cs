...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateTelephone :  IEquatable<TpdmTeacherCandidateTelephone>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateTelephone" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateTelephone() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateTelephone" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidateTelephone(string telephoneNumberTypeDescriptor = default(string), string telephoneNumber = default(string), bool? doNotPublishIndicator = default(bool?), int? orderOfPriority = default(int?), bool? textMessageCapabilityIndicator = default(bool?))
        {
            // to ensure "telephoneNumberTypeDescriptor" is required (not null)
            if (telephoneNumberTypeDescriptor == null)
            {
                throw new InvalidDataException("telephoneNumberTypeDescriptor is a required property for TpdmTeacherCandidateTelephone and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("telephoneNumber is a required property for TpdmTeacherCandidateTelephone and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateTelephone);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateTelephone instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateTelephone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateTelephone input)
        {
            if (input == null)
                return false;
