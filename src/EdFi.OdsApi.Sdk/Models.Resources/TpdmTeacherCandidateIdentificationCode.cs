...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateIdentificationCode :  IEquatable<TpdmTeacherCandidateIdentificationCode>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateIdentificationCode" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateIdentificationCode() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateIdentificationCode" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidateIdentificationCode(string studentIdentificationSystemDescriptor = default(string), string assigningOrganizationIdentificationCode = default(string), string identificationCode = default(string))
        {
            // to ensure "studentIdentificationSystemDescriptor" is required (not null)
            if (studentIdentificationSystemDescriptor == null)
            {
                throw new InvalidDataException("studentIdentificationSystemDescriptor is a required property for TpdmTeacherCandidateIdentificationCode and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("assigningOrganizationIdentificationCode is a required property for TpdmTeacherCandidateIdentificationCode and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("identificationCode is a required property for TpdmTeacherCandidateIdentificationCode and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateIdentificationCode);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateIdentificationCode instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateIdentificationCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateIdentificationCode input)
        {
            if (input == null)
                return false;
