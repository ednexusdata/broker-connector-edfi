...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmStaffTeacherPreparationProgram :  IEquatable<TpdmStaffTeacherPreparationProgram>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmStaffTeacherPreparationProgram" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmStaffTeacherPreparationProgram() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmStaffTeacherPreparationProgram" /> class.
        /// </summary>
        ...
        public TpdmStaffTeacherPreparationProgram(string teacherPreparationProgramName = default(string), string levelOfDegreeAwardedDescriptor = default(string), string teacherPreparationProgramTypeDescriptor = default(string), double? gpa = default(double?), string majorSpecialization = default(string), string nameOfInstitution = default(string), string teacherPreparationProgramIdentifier = default(string))
        {
            ...
            {
                throw new InvalidDataException("levelOfDegreeAwardedDescriptor is a required property for TpdmStaffTeacherPreparationProgram and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("teacherPreparationProgramTypeDescriptor is a required property for TpdmStaffTeacherPreparationProgram and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("majorSpecialization is a required property for TpdmStaffTeacherPreparationProgram and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("nameOfInstitution is a required property for TpdmStaffTeacherPreparationProgram and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmStaffTeacherPreparationProgram);
        }

        /// <summary>
        /// Returns true if TpdmStaffTeacherPreparationProgram instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmStaffTeacherPreparationProgram to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmStaffTeacherPreparationProgram input)
        {
            if (input == null)
                return false;
