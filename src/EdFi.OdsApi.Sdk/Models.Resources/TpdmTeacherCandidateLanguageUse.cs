...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateLanguageUse :  IEquatable<TpdmTeacherCandidateLanguageUse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateLanguageUse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateLanguageUse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateLanguageUse" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidateLanguageUse(string languageUseDescriptor = default(string))
        {
            // to ensure "languageUseDescriptor" is required (not null)
            if (languageUseDescriptor == null)
            {
                throw new InvalidDataException("languageUseDescriptor is a required property for TpdmTeacherCandidateLanguageUse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateLanguageUse);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateLanguageUse instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateLanguageUse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateLanguageUse input)
        {
            if (input == null)
                return false;
