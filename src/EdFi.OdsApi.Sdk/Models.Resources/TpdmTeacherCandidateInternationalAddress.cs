...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateInternationalAddress :  IEquatable<TpdmTeacherCandidateInternationalAddress>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateInternationalAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateInternationalAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateInternationalAddress" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidateInternationalAddress(string addressTypeDescriptor = default(string), string countryDescriptor = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string addressLine4 = default(string), DateTime? beginDate = default(DateTime?), DateTime? endDate = default(DateTime?), string latitude = default(string), string longitude = default(string))
        {
            // to ensure "addressTypeDescriptor" is required (not null)
            if (addressTypeDescriptor == null)
            {
                throw new InvalidDataException("addressTypeDescriptor is a required property for TpdmTeacherCandidateInternationalAddress and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("countryDescriptor is a required property for TpdmTeacherCandidateInternationalAddress and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("addressLine1 is a required property for TpdmTeacherCandidateInternationalAddress and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateInternationalAddress);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateInternationalAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateInternationalAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateInternationalAddress input)
        {
            if (input == null)
                return false;
