...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleStudentFavoriteBookArtMedium :  IEquatable<SampleStudentFavoriteBookArtMedium>
    {
        /// <summary>
        ...
        public SampleStudentFavoriteBookArtMedium(string artMediumDescriptor = default(string), int? artPieces = default(int?))
        {
            ...
            {
                throw new InvalidDataException("artMediumDescriptor is a required property for SampleStudentFavoriteBookArtMedium and cannot be null");
            }
            else
            {
