...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateBackgroundCheck :  IEquatable<TpdmTeacherCandidateBackgroundCheck>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateBackgroundCheck" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateBackgroundCheck() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateBackgroundCheck" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidateBackgroundCheck(string backgroundCheckStatusDescriptor = default(string), string backgroundCheckTypeDescriptor = default(string), DateTime? backgroundCheckCompletedDate = default(DateTime?), DateTime? backgroundCheckRequestedDate = default(DateTime?), bool? fingerprint = default(bool?))
        {
            // to ensure "backgroundCheckTypeDescriptor" is required (not null)
            if (backgroundCheckTypeDescriptor == null)
            {
                throw new InvalidDataException("backgroundCheckTypeDescriptor is a required property for TpdmTeacherCandidateBackgroundCheck and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("backgroundCheckRequestedDate is a required property for TpdmTeacherCandidateBackgroundCheck and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateBackgroundCheck);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateBackgroundCheck instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateBackgroundCheck to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateBackgroundCheck input)
        {
            if (input == null)
                return false;
