...
{
    /// <summary>
    /// TpdmApplicationGradePointAverage
    /// </summary>
    [DataContract]
    public partial class TpdmApplicationGradePointAverage :  IEquatable<TpdmApplicationGradePointAverage>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicationGradePointAverage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicationGradePointAverage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicationGradePointAverage" /> class.
        /// </summary>
        ...
        public TpdmApplicationGradePointAverage(string gradePointAverageTypeDescriptor = default(string), double? gradePointAverageValue = default(double?), bool? isCumulative = default(bool?), double? maxGradePointAverageValue = default(double?))
        {
            // to ensure "gradePointAverageTypeDescriptor" is required (not null)
            if (gradePointAverageTypeDescriptor == null)
            {
                throw new InvalidDataException("gradePointAverageTypeDescriptor is a required property for TpdmApplicationGradePointAverage and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("gradePointAverageValue is a required property for TpdmApplicationGradePointAverage and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmApplicationGradePointAverage {\n");
        ...
        {
            return this.Equals(input as TpdmApplicationGradePointAverage);
        }

        /// <summary>
        /// Returns true if TpdmApplicationGradePointAverage instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicationGradePointAverage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicationGradePointAverage input)
        {
            if (input == null)
                return false;
