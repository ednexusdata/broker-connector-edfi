...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmApplicantIdentificationDocument :  IEquatable<TpdmApplicantIdentificationDocument>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantIdentificationDocument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantIdentificationDocument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantIdentificationDocument" /> class.
        /// </summary>
        ...
        public TpdmApplicantIdentificationDocument(string identificationDocumentUseDescriptor = default(string), string personalInformationVerificationDescriptor = default(string), string issuerCountryDescriptor = default(string), DateTime? documentExpirationDate = default(DateTime?), string documentTitle = default(string), string issuerDocumentIdentificationCode = default(string), string issuerName = default(string))
        {
            ...
            {
                throw new InvalidDataException("personalInformationVerificationDescriptor is a required property for TpdmApplicantIdentificationDocument and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmApplicantIdentificationDocument);
        }

        /// <summary>
        /// Returns true if TpdmApplicantIdentificationDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantIdentificationDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantIdentificationDocument input)
        {
            if (input == null)
                return false;
