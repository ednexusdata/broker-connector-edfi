...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmProspectDisabilityDesignation :  IEquatable<TpdmProspectDisabilityDesignation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmProspectDisabilityDesignation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmProspectDisabilityDesignation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmProspectDisabilityDesignation" /> class.
        /// </summary>
        ...
        public TpdmProspectDisabilityDesignation(string disabilityDesignationDescriptor = default(string))
        {
            // to ensure "disabilityDesignationDescriptor" is required (not null)
            if (disabilityDesignationDescriptor == null)
            {
                throw new InvalidDataException("disabilityDesignationDescriptor is a required property for TpdmProspectDisabilityDesignation and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmProspectDisabilityDesignation);
        }

        /// <summary>
        /// Returns true if TpdmProspectDisabilityDesignation instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmProspectDisabilityDesignation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmProspectDisabilityDesignation input)
        {
            if (input == null)
                return false;
