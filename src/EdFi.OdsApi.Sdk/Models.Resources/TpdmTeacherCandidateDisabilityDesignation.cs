...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateDisabilityDesignation :  IEquatable<TpdmTeacherCandidateDisabilityDesignation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateDisabilityDesignation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateDisabilityDesignation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateDisabilityDesignation" /> class.
        /// </summary>
        ...
        public TpdmTeacherCandidateDisabilityDesignation(string disabilityDesignationDescriptor = default(string))
        {
            // to ensure "disabilityDesignationDescriptor" is required (not null)
            if (disabilityDesignationDescriptor == null)
            {
                throw new InvalidDataException("disabilityDesignationDescriptor is a required property for TpdmTeacherCandidateDisabilityDesignation and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateDisabilityDesignation);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateDisabilityDesignation instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateDisabilityDesignation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateDisabilityDesignation input)
        {
            if (input == null)
                return false;
