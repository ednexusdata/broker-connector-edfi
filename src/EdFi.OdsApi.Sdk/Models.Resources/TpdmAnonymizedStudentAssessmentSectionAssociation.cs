...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmAnonymizedStudentAssessmentSectionAssociation :  IEquatable<TpdmAnonymizedStudentAssessmentSectionAssociation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmAnonymizedStudentAssessmentSectionAssociation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmAnonymizedStudentAssessmentSectionAssociation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmAnonymizedStudentAssessmentSectionAssociation" /> class.
        /// </summary>
        ...
        public TpdmAnonymizedStudentAssessmentSectionAssociation(string id = default(string), TpdmAnonymizedStudentAssessmentReference anonymizedStudentAssessmentReference = default(TpdmAnonymizedStudentAssessmentReference), EdFiSectionReference sectionReference = default(EdFiSectionReference), string etag = default(string))
        {
            // to ensure "anonymizedStudentAssessmentReference" is required (not null)
            if (anonymizedStudentAssessmentReference == null)
            {
                throw new InvalidDataException("anonymizedStudentAssessmentReference is a required property for TpdmAnonymizedStudentAssessmentSectionAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sectionReference is a required property for TpdmAnonymizedStudentAssessmentSectionAssociation and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmAnonymizedStudentAssessmentSectionAssociation);
        }

        /// <summary>
        /// Returns true if TpdmAnonymizedStudentAssessmentSectionAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmAnonymizedStudentAssessmentSectionAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmAnonymizedStudentAssessmentSectionAssociation input)
        {
            if (input == null)
                return false;
