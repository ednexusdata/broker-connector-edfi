...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmSurveyResponseTeacherCandidateTargetAssociation :  IEquatable<TpdmSurveyResponseTeacherCandidateTargetAssociation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmSurveyResponseTeacherCandidateTargetAssociation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmSurveyResponseTeacherCandidateTargetAssociation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmSurveyResponseTeacherCandidateTargetAssociation" /> class.
        /// </summary>
        ...
        public TpdmSurveyResponseTeacherCandidateTargetAssociation(string id = default(string), EdFiSurveyResponseReference surveyResponseReference = default(EdFiSurveyResponseReference), TpdmTeacherCandidateReference teacherCandidateReference = default(TpdmTeacherCandidateReference), string etag = default(string))
        {
            // to ensure "surveyResponseReference" is required (not null)
            if (surveyResponseReference == null)
            {
                throw new InvalidDataException("surveyResponseReference is a required property for TpdmSurveyResponseTeacherCandidateTargetAssociation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("teacherCandidateReference is a required property for TpdmSurveyResponseTeacherCandidateTargetAssociation and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmSurveyResponseTeacherCandidateTargetAssociation);
        }

        /// <summary>
        /// Returns true if TpdmSurveyResponseTeacherCandidateTargetAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmSurveyResponseTeacherCandidateTargetAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmSurveyResponseTeacherCandidateTargetAssociation input)
        {
            if (input == null)
                return false;
