...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmProspectPersonalIdentificationDocument :  IEquatable<TpdmProspectPersonalIdentificationDocument>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmProspectPersonalIdentificationDocument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmProspectPersonalIdentificationDocument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmProspectPersonalIdentificationDocument" /> class.
        /// </summary>
        ...
        public TpdmProspectPersonalIdentificationDocument(string identificationDocumentUseDescriptor = default(string), string personalInformationVerificationDescriptor = default(string), string issuerCountryDescriptor = default(string), DateTime? documentExpirationDate = default(DateTime?), string documentTitle = default(string), string issuerDocumentIdentificationCode = default(string), string issuerName = default(string))
        {
            ...
            {
                throw new InvalidDataException("personalInformationVerificationDescriptor is a required property for TpdmProspectPersonalIdentificationDocument and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TpdmProspectPersonalIdentificationDocument);
        }

        /// <summary>
        /// Returns true if TpdmProspectPersonalIdentificationDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmProspectPersonalIdentificationDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmProspectPersonalIdentificationDocument input)
        {
            if (input == null)
                return false;
