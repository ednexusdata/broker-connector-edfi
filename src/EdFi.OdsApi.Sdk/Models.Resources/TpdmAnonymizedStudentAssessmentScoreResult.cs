...
namespace EdFi.OdsApi.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmAnonymizedStudentAssessmentScoreResult :  IEquatable<TpdmAnonymizedStudentAssessmentScoreResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmAnonymizedStudentAssessmentScoreResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmAnonymizedStudentAssessmentScoreResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmAnonymizedStudentAssessmentScoreResult" /> class.
        /// </summary>
        ...
        public TpdmAnonymizedStudentAssessmentScoreResult(string assessmentReportingMethodDescriptor = default(string), string resultDatatypeTypeDescriptor = default(string), string result = default(string))
        {
            // to ensure "assessmentReportingMethodDescriptor" is required (not null)
            if (assessmentReportingMethodDescriptor == null)
            {
                throw new InvalidDataException("assessmentReportingMethodDescriptor is a required property for TpdmAnonymizedStudentAssessmentScoreResult and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("resultDatatypeTypeDescriptor is a required property for TpdmAnonymizedStudentAssessmentScoreResult and cannot be null");
            }
            else
            {
            ...
            if (result == null)
            {
                throw new InvalidDataException("result is a required property for TpdmAnonymizedStudentAssessmentScoreResult and cannot be null");
            }
            else
            {
                this.Result = result;
        ...
        {
            return this.Equals(input as TpdmAnonymizedStudentAssessmentScoreResult);
        }

        /// <summary>
        /// Returns true if TpdmAnonymizedStudentAssessmentScoreResult instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmAnonymizedStudentAssessmentScoreResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmAnonymizedStudentAssessmentScoreResult input)
        {
            if (input == null)
                return false;
