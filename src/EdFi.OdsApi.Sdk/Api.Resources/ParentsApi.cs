...
namespace EdFi.OdsApi.Sdk.Api.Resources
{
    ...
    public interface IParentsApi : IApiAccessor
    {
        ...
        List<EdFiParent> GetParents (int? offset = null, int? limit = null, bool? totalCount = null, string parentUniqueId = null, string personId = null, string sourceSystemDescriptor = null, string sexDescriptor = null, string firstName = null, string generationCodeSuffix = null, string id = null, string lastSurname = null, string loginId = null, string maidenName = null, string middleName = null, string personalTitlePrefix = null);
        ...
        ApiResponse<EdFiParent> GetParentsByIdWithHttpInfo (string id, string ifNoneMatch = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<EdFiParent> GetParentsByIdAsync (string id, string ifNoneMatch = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<EdFiParent>> GetParentsByIdAsyncWithHttpInfo (string id, string ifNoneMatch = null);
        /// <summary>
        /// Creates or updates resources based on the natural key values of the supplied resource.
        /// </summary>
        /// <remarks>
    ...
    public partial class ParentsApi : IParentsApi
    {
        ...
        {
             ApiResponse<List<EdFiParent>> localVarResponse = GetParentsWithHttpInfo(offset, limit, totalCount, parentUniqueId, personId, sourceSystemDescriptor, sexDescriptor, firstName, generationCodeSuffix, id, lastSurname, loginId, maidenName, middleName, personalTitlePrefix);
        ...
        {
             ApiResponse<List<EdFiParent>> localVarResponse = await GetParentsAsyncWithHttpInfo(offset, limit, totalCount, parentUniqueId, personId, sourceSystemDescriptor, sexDescriptor, firstName, generationCodeSuffix, id, lastSurname, loginId, maidenName, middleName, personalTitlePrefix);
             return localVarResponse.Data;
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>EdFiParent</returns>
        public EdFiParent GetParentsById (string id, string ifNoneMatch = null)
        {
             ApiResponse<EdFiParent> localVarResponse = GetParentsByIdWithHttpInfo(id, ifNoneMatch);
             return localVarResponse.Data;
        }
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>ApiResponse of EdFiParent</returns>
        public ApiResponse< EdFiParent > GetParentsByIdWithHttpInfo (string id, string ifNoneMatch = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>Task of EdFiParent</returns>
        public async System.Threading.Tasks.Task<EdFiParent> GetParentsByIdAsync (string id, string ifNoneMatch = null)
        {
             ApiResponse<EdFiParent> localVarResponse = await GetParentsByIdAsyncWithHttpInfo(id, ifNoneMatch);
             return localVarResponse.Data;
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>Task of ApiResponse (EdFiParent)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EdFiParent>> GetParentsByIdAsyncWithHttpInfo (string id, string ifNoneMatch = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ParentsApi->GetParentsById");
