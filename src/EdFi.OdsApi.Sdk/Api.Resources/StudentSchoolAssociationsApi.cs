...
namespace EdFi.OdsApi.Sdk.Api.Resources
{
    ...
    public interface IStudentSchoolAssociationsApi : IApiAccessor
    {
        ...
        ApiResponse<EdFiStudentSchoolAssociation> GetStudentSchoolAssociationsByIdWithHttpInfo (string id, string ifNoneMatch = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<EdFiStudentSchoolAssociation> GetStudentSchoolAssociationsByIdAsync (string id, string ifNoneMatch = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<EdFiStudentSchoolAssociation>> GetStudentSchoolAssociationsByIdAsyncWithHttpInfo (string id, string ifNoneMatch = null);
        /// <summary>
        /// Creates or updates resources based on the natural key values of the supplied resource.
        /// </summary>
        /// <remarks>
    ...
    public partial class StudentSchoolAssociationsApi : IStudentSchoolAssociationsApi
    {
        ...
        {
             ApiResponse<List<EdFiStudentSchoolAssociation>> localVarResponse = await GetStudentSchoolAssociationsAsyncWithHttpInfo(offset, limit, totalCount, entryDate, schoolId, studentUniqueId, calendarCode, schoolYear, educationOrganizationId, graduationPlanTypeDescriptor, graduationSchoolYear, classOfSchoolYear, entryGradeLevelReasonDescriptor, entryTypeDescriptor, exitWithdrawTypeDescriptor, entryGradeLevelDescriptor, residencyStatusDescriptor, employedWhileEnrolled, exitWithdrawDate, fullTimeEquivalency, id, primarySchool, repeatGradeIndicator, schoolChoiceTransfer, termCompletionIndicator);
             return localVarResponse.Data;
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>EdFiStudentSchoolAssociation</returns>
        public EdFiStudentSchoolAssociation GetStudentSchoolAssociationsById (string id, string ifNoneMatch = null)
        {
             ApiResponse<EdFiStudentSchoolAssociation> localVarResponse = GetStudentSchoolAssociationsByIdWithHttpInfo(id, ifNoneMatch);
             return localVarResponse.Data;
        }
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>ApiResponse of EdFiStudentSchoolAssociation</returns>
        public ApiResponse< EdFiStudentSchoolAssociation > GetStudentSchoolAssociationsByIdWithHttpInfo (string id, string ifNoneMatch = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>Task of EdFiStudentSchoolAssociation</returns>
        public async System.Threading.Tasks.Task<EdFiStudentSchoolAssociation> GetStudentSchoolAssociationsByIdAsync (string id, string ifNoneMatch = null)
        {
             ApiResponse<EdFiStudentSchoolAssociation> localVarResponse = await GetStudentSchoolAssociationsByIdAsyncWithHttpInfo(id, ifNoneMatch);
             return localVarResponse.Data;
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>Task of ApiResponse (EdFiStudentSchoolAssociation)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EdFiStudentSchoolAssociation>> GetStudentSchoolAssociationsByIdAsyncWithHttpInfo (string id, string ifNoneMatch = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling StudentSchoolAssociationsApi->GetStudentSchoolAssociationsById");
