...
namespace EdFi.OdsApi.Sdk.Api.Resources
{
    ...
    public interface IStudentAcademicRecordsApi : IApiAccessor
    {
        ...
        ApiResponse<EdFiStudentAcademicRecord> GetStudentAcademicRecordsByIdWithHttpInfo (string id, string ifNoneMatch = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<EdFiStudentAcademicRecord> GetStudentAcademicRecordsByIdAsync (string id, string ifNoneMatch = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<EdFiStudentAcademicRecord>> GetStudentAcademicRecordsByIdAsyncWithHttpInfo (string id, string ifNoneMatch = null);
        /// <summary>
        /// Creates or updates resources based on the natural key values of the supplied resource.
        /// </summary>
        /// <remarks>
    ...
    public partial class StudentAcademicRecordsApi : IStudentAcademicRecordsApi
    {
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>EdFiStudentAcademicRecord</returns>
        public EdFiStudentAcademicRecord GetStudentAcademicRecordsById (string id, string ifNoneMatch = null)
        {
             ApiResponse<EdFiStudentAcademicRecord> localVarResponse = GetStudentAcademicRecordsByIdWithHttpInfo(id, ifNoneMatch);
             return localVarResponse.Data;
        }
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>ApiResponse of EdFiStudentAcademicRecord</returns>
        public ApiResponse< EdFiStudentAcademicRecord > GetStudentAcademicRecordsByIdWithHttpInfo (string id, string ifNoneMatch = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>Task of EdFiStudentAcademicRecord</returns>
        public async System.Threading.Tasks.Task<EdFiStudentAcademicRecord> GetStudentAcademicRecordsByIdAsync (string id, string ifNoneMatch = null)
        {
             ApiResponse<EdFiStudentAcademicRecord> localVarResponse = await GetStudentAcademicRecordsByIdAsyncWithHttpInfo(id, ifNoneMatch);
             return localVarResponse.Data;
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>Task of ApiResponse (EdFiStudentAcademicRecord)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EdFiStudentAcademicRecord>> GetStudentAcademicRecordsByIdAsyncWithHttpInfo (string id, string ifNoneMatch = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling StudentAcademicRecordsApi->GetStudentAcademicRecordsById");
