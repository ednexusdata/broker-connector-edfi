...
namespace EdFi.OdsApi.Sdk.Api.Resources
{
    ...
    public interface IGradesApi : IApiAccessor
    {
        ...
        ApiResponse<EdFiGrade> GetGradesByIdWithHttpInfo (string id, string ifNoneMatch = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<EdFiGrade> GetGradesByIdAsync (string id, string ifNoneMatch = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<EdFiGrade>> GetGradesByIdAsyncWithHttpInfo (string id, string ifNoneMatch = null);
        /// <summary>
        /// Creates or updates resources based on the natural key values of the supplied resource.
        /// </summary>
        /// <remarks>
    ...
    public partial class GradesApi : IGradesApi
    {
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>EdFiGrade</returns>
        public EdFiGrade GetGradesById (string id, string ifNoneMatch = null)
        {
             ApiResponse<EdFiGrade> localVarResponse = GetGradesByIdWithHttpInfo(id, ifNoneMatch);
             return localVarResponse.Data;
        }
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>ApiResponse of EdFiGrade</returns>
        public ApiResponse< EdFiGrade > GetGradesByIdWithHttpInfo (string id, string ifNoneMatch = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>Task of EdFiGrade</returns>
        public async System.Threading.Tasks.Task<EdFiGrade> GetGradesByIdAsync (string id, string ifNoneMatch = null)
        {
             ApiResponse<EdFiGrade> localVarResponse = await GetGradesByIdAsyncWithHttpInfo(id, ifNoneMatch);
             return localVarResponse.Data;
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>Task of ApiResponse (EdFiGrade)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EdFiGrade>> GetGradesByIdAsyncWithHttpInfo (string id, string ifNoneMatch = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling GradesApi->GetGradesById");
