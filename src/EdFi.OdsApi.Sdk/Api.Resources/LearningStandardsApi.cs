...
namespace EdFi.OdsApi.Sdk.Api.Resources
{
    ...
    public interface ILearningStandardsApi : IApiAccessor
    {
        ...
        ApiResponse<EdFiLearningStandard> GetLearningStandardsByIdWithHttpInfo (string id, string ifNoneMatch = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<EdFiLearningStandard> GetLearningStandardsByIdAsync (string id, string ifNoneMatch = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<EdFiLearningStandard>> GetLearningStandardsByIdAsyncWithHttpInfo (string id, string ifNoneMatch = null);
        /// <summary>
        /// Creates or updates resources based on the natural key values of the supplied resource.
        /// </summary>
        /// <remarks>
    ...
    public partial class LearningStandardsApi : ILearningStandardsApi
    {
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>EdFiLearningStandard</returns>
        public EdFiLearningStandard GetLearningStandardsById (string id, string ifNoneMatch = null)
        {
             ApiResponse<EdFiLearningStandard> localVarResponse = GetLearningStandardsByIdWithHttpInfo(id, ifNoneMatch);
             return localVarResponse.Data;
        }
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>ApiResponse of EdFiLearningStandard</returns>
        public ApiResponse< EdFiLearningStandard > GetLearningStandardsByIdWithHttpInfo (string id, string ifNoneMatch = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>Task of EdFiLearningStandard</returns>
        public async System.Threading.Tasks.Task<EdFiLearningStandard> GetLearningStandardsByIdAsync (string id, string ifNoneMatch = null)
        {
             ApiResponse<EdFiLearningStandard> localVarResponse = await GetLearningStandardsByIdAsyncWithHttpInfo(id, ifNoneMatch);
             return localVarResponse.Data;
        ...
        /// <param name="ifNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)</param>
        /// <returns>Task of ApiResponse (EdFiLearningStandard)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EdFiLearningStandard>> GetLearningStandardsByIdAsyncWithHttpInfo (string id, string ifNoneMatch = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling LearningStandardsApi->GetLearningStandardsById");
