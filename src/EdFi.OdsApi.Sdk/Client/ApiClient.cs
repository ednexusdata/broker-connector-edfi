...
namespace EdFi.OdsApi.Sdk.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("https://api-stage.ed-fi.org:443/v5.2/api/data/v3");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api-stage.ed-fi.org:443/v5.2/api/data/v3).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://api.ed-fi.org:443/v5.2/api/data/v3")
        {
