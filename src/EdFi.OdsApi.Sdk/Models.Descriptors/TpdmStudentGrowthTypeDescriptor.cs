...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmStudentGrowthTypeDescriptor :  IEquatable<TpdmStudentGrowthTypeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmStudentGrowthTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmStudentGrowthTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmStudentGrowthTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="studentGrowthTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmStudentGrowthTypeDescriptor(string id = default(string), int? studentGrowthTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmStudentGrowthTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmStudentGrowthTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmStudentGrowthTypeDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="studentGrowthTypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  StudentGrowthTypeDescriptorId: ").Append(StudentGrowthTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmStudentGrowthTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmStudentGrowthTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmStudentGrowthTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmStudentGrowthTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.StudentGrowthTypeDescriptorId == input.StudentGrowthTypeDescriptorId ||
                    (this.StudentGrowthTypeDescriptorId != null &&
                    this.StudentGrowthTypeDescriptorId.Equals(input.StudentGrowthTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StudentGrowthTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.StudentGrowthTypeDescriptorId.GetHashCode();
