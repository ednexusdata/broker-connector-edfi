...
{
    /// <summary>
    /// TpdmCertificationLevelDescriptor
    /// </summary>
    [DataContract]
    public partial class TpdmCertificationLevelDescriptor :  IEquatable<TpdmCertificationLevelDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCertificationLevelDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmCertificationLevelDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCertificationLevelDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="certificationLevelDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmCertificationLevelDescriptor(string id = default(string), int? certificationLevelDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmCertificationLevelDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmCertificationLevelDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmCertificationLevelDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.CertificationLevelDescriptorId = certificationLevelDescriptorId;
        ...
        [DataMember(Name="certificationLevelDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmCertificationLevelDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  CertificationLevelDescriptorId: ").Append(CertificationLevelDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmCertificationLevelDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmCertificationLevelDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmCertificationLevelDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmCertificationLevelDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CertificationLevelDescriptorId == input.CertificationLevelDescriptorId ||
                    (this.CertificationLevelDescriptorId != null &&
                    this.CertificationLevelDescriptorId.Equals(input.CertificationLevelDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CertificationLevelDescriptorId != null)
                    hashCode = hashCode * 59 + this.CertificationLevelDescriptorId.GetHashCode();
