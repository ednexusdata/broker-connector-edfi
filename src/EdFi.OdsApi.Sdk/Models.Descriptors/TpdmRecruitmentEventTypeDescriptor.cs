...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmRecruitmentEventTypeDescriptor :  IEquatable<TpdmRecruitmentEventTypeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmRecruitmentEventTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmRecruitmentEventTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmRecruitmentEventTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="recruitmentEventTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmRecruitmentEventTypeDescriptor(string id = default(string), int? recruitmentEventTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmRecruitmentEventTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmRecruitmentEventTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmRecruitmentEventTypeDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="recruitmentEventTypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RecruitmentEventTypeDescriptorId: ").Append(RecruitmentEventTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmRecruitmentEventTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmRecruitmentEventTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmRecruitmentEventTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmRecruitmentEventTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RecruitmentEventTypeDescriptorId == input.RecruitmentEventTypeDescriptorId ||
                    (this.RecruitmentEventTypeDescriptorId != null &&
                    this.RecruitmentEventTypeDescriptorId.Equals(input.RecruitmentEventTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RecruitmentEventTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.RecruitmentEventTypeDescriptorId.GetHashCode();
