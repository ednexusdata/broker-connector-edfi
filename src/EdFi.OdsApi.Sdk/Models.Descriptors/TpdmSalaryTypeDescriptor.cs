...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmSalaryTypeDescriptor :  IEquatable<TpdmSalaryTypeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmSalaryTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmSalaryTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmSalaryTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="salaryTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmSalaryTypeDescriptor(string id = default(string), int? salaryTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmSalaryTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmSalaryTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmSalaryTypeDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="salaryTypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SalaryTypeDescriptorId: ").Append(SalaryTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmSalaryTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmSalaryTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmSalaryTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmSalaryTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SalaryTypeDescriptorId == input.SalaryTypeDescriptorId ||
                    (this.SalaryTypeDescriptorId != null &&
                    this.SalaryTypeDescriptorId.Equals(input.SalaryTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SalaryTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.SalaryTypeDescriptorId.GetHashCode();
