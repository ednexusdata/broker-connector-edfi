...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmPreviousCareerDescriptor :  IEquatable<TpdmPreviousCareerDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmPreviousCareerDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmPreviousCareerDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmPreviousCareerDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="previousCareerDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmPreviousCareerDescriptor(string id = default(string), int? previousCareerDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmPreviousCareerDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmPreviousCareerDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmPreviousCareerDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="previousCareerDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PreviousCareerDescriptorId: ").Append(PreviousCareerDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmPreviousCareerDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmPreviousCareerDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmPreviousCareerDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmPreviousCareerDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PreviousCareerDescriptorId == input.PreviousCareerDescriptorId ||
                    (this.PreviousCareerDescriptorId != null &&
                    this.PreviousCareerDescriptorId.Equals(input.PreviousCareerDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PreviousCareerDescriptorId != null)
                    hashCode = hashCode * 59 + this.PreviousCareerDescriptorId.GetHashCode();
