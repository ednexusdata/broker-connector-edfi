...
{
    /// <summary>
    /// TpdmInstructionalSettingDescriptor
    /// </summary>
    [DataContract]
    public partial class TpdmInstructionalSettingDescriptor :  IEquatable<TpdmInstructionalSettingDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmInstructionalSettingDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmInstructionalSettingDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmInstructionalSettingDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="instructionalSettingDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmInstructionalSettingDescriptor(string id = default(string), int? instructionalSettingDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmInstructionalSettingDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmInstructionalSettingDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.InstructionalSettingDescriptorId = instructionalSettingDescriptorId;
        ...
        [DataMember(Name="instructionalSettingDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmInstructionalSettingDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  InstructionalSettingDescriptorId: ").Append(InstructionalSettingDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmInstructionalSettingDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmInstructionalSettingDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmInstructionalSettingDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmInstructionalSettingDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.InstructionalSettingDescriptorId == input.InstructionalSettingDescriptorId ||
                    (this.InstructionalSettingDescriptorId != null &&
                    this.InstructionalSettingDescriptorId.Equals(input.InstructionalSettingDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InstructionalSettingDescriptorId != null)
                    hashCode = hashCode * 59 + this.InstructionalSettingDescriptorId.GetHashCode();
