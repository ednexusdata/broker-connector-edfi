...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTppDegreeTypeDescriptor :  IEquatable<TpdmTppDegreeTypeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTppDegreeTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTppDegreeTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTppDegreeTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="tppDegreeTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmTppDegreeTypeDescriptor(string id = default(string), int? tppDegreeTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmTppDegreeTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmTppDegreeTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmTppDegreeTypeDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="tppDegreeTypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TppDegreeTypeDescriptorId: ").Append(TppDegreeTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmTppDegreeTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmTppDegreeTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTppDegreeTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTppDegreeTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TppDegreeTypeDescriptorId == input.TppDegreeTypeDescriptorId ||
                    (this.TppDegreeTypeDescriptorId != null &&
                    this.TppDegreeTypeDescriptorId.Equals(input.TppDegreeTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TppDegreeTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.TppDegreeTypeDescriptorId.GetHashCode();
