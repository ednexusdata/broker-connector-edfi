...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmBackgroundCheckStatusDescriptor :  IEquatable<TpdmBackgroundCheckStatusDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmBackgroundCheckStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmBackgroundCheckStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmBackgroundCheckStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="backgroundCheckStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmBackgroundCheckStatusDescriptor(string id = default(string), int? backgroundCheckStatusDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmBackgroundCheckStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmBackgroundCheckStatusDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="backgroundCheckStatusDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BackgroundCheckStatusDescriptorId: ").Append(BackgroundCheckStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmBackgroundCheckStatusDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmBackgroundCheckStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmBackgroundCheckStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmBackgroundCheckStatusDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.BackgroundCheckStatusDescriptorId == input.BackgroundCheckStatusDescriptorId ||
                    (this.BackgroundCheckStatusDescriptorId != null &&
                    this.BackgroundCheckStatusDescriptorId.Equals(input.BackgroundCheckStatusDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BackgroundCheckStatusDescriptorId != null)
                    hashCode = hashCode * 59 + this.BackgroundCheckStatusDescriptorId.GetHashCode();
