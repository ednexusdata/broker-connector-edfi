...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTppProgramPathwayDescriptor :  IEquatable<TpdmTppProgramPathwayDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTppProgramPathwayDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTppProgramPathwayDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTppProgramPathwayDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="tppProgramPathwayDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmTppProgramPathwayDescriptor(string id = default(string), int? tppProgramPathwayDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmTppProgramPathwayDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmTppProgramPathwayDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmTppProgramPathwayDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="tppProgramPathwayDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TppProgramPathwayDescriptorId: ").Append(TppProgramPathwayDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmTppProgramPathwayDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmTppProgramPathwayDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTppProgramPathwayDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTppProgramPathwayDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TppProgramPathwayDescriptorId == input.TppProgramPathwayDescriptorId ||
                    (this.TppProgramPathwayDescriptorId != null &&
                    this.TppProgramPathwayDescriptorId.Equals(input.TppProgramPathwayDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TppProgramPathwayDescriptorId != null)
                    hashCode = hashCode * 59 + this.TppProgramPathwayDescriptorId.GetHashCode();
