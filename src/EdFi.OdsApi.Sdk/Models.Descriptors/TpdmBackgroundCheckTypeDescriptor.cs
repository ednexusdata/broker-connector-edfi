...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmBackgroundCheckTypeDescriptor :  IEquatable<TpdmBackgroundCheckTypeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmBackgroundCheckTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmBackgroundCheckTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmBackgroundCheckTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="backgroundCheckTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmBackgroundCheckTypeDescriptor(string id = default(string), int? backgroundCheckTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmBackgroundCheckTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmBackgroundCheckTypeDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="backgroundCheckTypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BackgroundCheckTypeDescriptorId: ").Append(BackgroundCheckTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmBackgroundCheckTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmBackgroundCheckTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmBackgroundCheckTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmBackgroundCheckTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.BackgroundCheckTypeDescriptorId == input.BackgroundCheckTypeDescriptorId ||
                    (this.BackgroundCheckTypeDescriptorId != null &&
                    this.BackgroundCheckTypeDescriptorId.Equals(input.BackgroundCheckTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BackgroundCheckTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.BackgroundCheckTypeDescriptorId.GetHashCode();
