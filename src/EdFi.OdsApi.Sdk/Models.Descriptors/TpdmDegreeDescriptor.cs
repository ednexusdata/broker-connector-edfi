...
{
    /// <summary>
    /// TpdmDegreeDescriptor
    /// </summary>
    [DataContract]
    public partial class TpdmDegreeDescriptor :  IEquatable<TpdmDegreeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmDegreeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmDegreeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmDegreeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="degreeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmDegreeDescriptor(string id = default(string), int? degreeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmDegreeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmDegreeDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.DegreeDescriptorId = degreeDescriptorId;
        ...
        [DataMember(Name="degreeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmDegreeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  DegreeDescriptorId: ").Append(DegreeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmDegreeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmDegreeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmDegreeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmDegreeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.DegreeDescriptorId == input.DegreeDescriptorId ||
                    (this.DegreeDescriptorId != null &&
                    this.DegreeDescriptorId.Equals(input.DegreeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DegreeDescriptorId != null)
                    hashCode = hashCode * 59 + this.DegreeDescriptorId.GetHashCode();
