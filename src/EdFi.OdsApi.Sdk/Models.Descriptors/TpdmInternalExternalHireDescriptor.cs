...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmInternalExternalHireDescriptor :  IEquatable<TpdmInternalExternalHireDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmInternalExternalHireDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmInternalExternalHireDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmInternalExternalHireDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="internalExternalHireDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmInternalExternalHireDescriptor(string id = default(string), int? internalExternalHireDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmInternalExternalHireDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmInternalExternalHireDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmInternalExternalHireDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="internalExternalHireDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InternalExternalHireDescriptorId: ").Append(InternalExternalHireDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmInternalExternalHireDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmInternalExternalHireDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmInternalExternalHireDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmInternalExternalHireDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.InternalExternalHireDescriptorId == input.InternalExternalHireDescriptorId ||
                    (this.InternalExternalHireDescriptorId != null &&
                    this.InternalExternalHireDescriptorId.Equals(input.InternalExternalHireDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InternalExternalHireDescriptorId != null)
                    hashCode = hashCode * 59 + this.InternalExternalHireDescriptorId.GetHashCode();
