...
{
    /// <summary>
    /// TpdmCertificationFieldDescriptor
    /// </summary>
    [DataContract]
    public partial class TpdmCertificationFieldDescriptor :  IEquatable<TpdmCertificationFieldDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCertificationFieldDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmCertificationFieldDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCertificationFieldDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="certificationFieldDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmCertificationFieldDescriptor(string id = default(string), int? certificationFieldDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmCertificationFieldDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmCertificationFieldDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmCertificationFieldDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.CertificationFieldDescriptorId = certificationFieldDescriptorId;
        ...
        [DataMember(Name="certificationFieldDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmCertificationFieldDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  CertificationFieldDescriptorId: ").Append(CertificationFieldDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmCertificationFieldDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmCertificationFieldDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmCertificationFieldDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmCertificationFieldDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CertificationFieldDescriptorId == input.CertificationFieldDescriptorId ||
                    (this.CertificationFieldDescriptorId != null &&
                    this.CertificationFieldDescriptorId.Equals(input.CertificationFieldDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CertificationFieldDescriptorId != null)
                    hashCode = hashCode * 59 + this.CertificationFieldDescriptorId.GetHashCode();
