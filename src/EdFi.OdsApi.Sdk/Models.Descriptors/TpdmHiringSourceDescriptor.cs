...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmHiringSourceDescriptor :  IEquatable<TpdmHiringSourceDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmHiringSourceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmHiringSourceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmHiringSourceDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="hiringSourceDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmHiringSourceDescriptor(string id = default(string), int? hiringSourceDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmHiringSourceDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmHiringSourceDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmHiringSourceDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="hiringSourceDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HiringSourceDescriptorId: ").Append(HiringSourceDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmHiringSourceDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmHiringSourceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmHiringSourceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmHiringSourceDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.HiringSourceDescriptorId == input.HiringSourceDescriptorId ||
                    (this.HiringSourceDescriptorId != null &&
                    this.HiringSourceDescriptorId.Equals(input.HiringSourceDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HiringSourceDescriptorId != null)
                    hashCode = hashCode * 59 + this.HiringSourceDescriptorId.GetHashCode();
