...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmOpenStaffPositionEventTypeDescriptor :  IEquatable<TpdmOpenStaffPositionEventTypeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmOpenStaffPositionEventTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmOpenStaffPositionEventTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmOpenStaffPositionEventTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="openStaffPositionEventTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmOpenStaffPositionEventTypeDescriptor(string id = default(string), int? openStaffPositionEventTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmOpenStaffPositionEventTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmOpenStaffPositionEventTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmOpenStaffPositionEventTypeDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="openStaffPositionEventTypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OpenStaffPositionEventTypeDescriptorId: ").Append(OpenStaffPositionEventTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmOpenStaffPositionEventTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmOpenStaffPositionEventTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmOpenStaffPositionEventTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmOpenStaffPositionEventTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.OpenStaffPositionEventTypeDescriptorId == input.OpenStaffPositionEventTypeDescriptorId ||
                    (this.OpenStaffPositionEventTypeDescriptorId != null &&
                    this.OpenStaffPositionEventTypeDescriptorId.Equals(input.OpenStaffPositionEventTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OpenStaffPositionEventTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.OpenStaffPositionEventTypeDescriptorId.GetHashCode();
