...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleFavoriteBookCategoryDescriptor :  IEquatable<SampleFavoriteBookCategoryDescriptor>
    {
        /// <summary>
        ...
        public SampleFavoriteBookCategoryDescriptor(string id = default(string), int? favoriteBookCategoryDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for SampleFavoriteBookCategoryDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for SampleFavoriteBookCategoryDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for SampleFavoriteBookCategoryDescriptor and cannot be null");
            }
            else
            {
        ...
        public bool Equals(SampleFavoriteBookCategoryDescriptor input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.FavoriteBookCategoryDescriptorId != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FavoriteBookCategoryDescriptorId != null)
