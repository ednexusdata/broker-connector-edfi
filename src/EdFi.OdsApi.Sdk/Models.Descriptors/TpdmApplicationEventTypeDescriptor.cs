...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmApplicationEventTypeDescriptor :  IEquatable<TpdmApplicationEventTypeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicationEventTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicationEventTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicationEventTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="applicationEventTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmApplicationEventTypeDescriptor(string id = default(string), int? applicationEventTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmApplicationEventTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmApplicationEventTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmApplicationEventTypeDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="applicationEventTypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ApplicationEventTypeDescriptorId: ").Append(ApplicationEventTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmApplicationEventTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmApplicationEventTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicationEventTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicationEventTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ApplicationEventTypeDescriptorId == input.ApplicationEventTypeDescriptorId ||
                    (this.ApplicationEventTypeDescriptorId != null &&
                    this.ApplicationEventTypeDescriptorId.Equals(input.ApplicationEventTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ApplicationEventTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.ApplicationEventTypeDescriptorId.GetHashCode();
