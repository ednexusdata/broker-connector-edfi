...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmValueTypeDescriptor :  IEquatable<TpdmValueTypeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmValueTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmValueTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmValueTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="valueTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmValueTypeDescriptor(string id = default(string), int? valueTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmValueTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmValueTypeDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="valueTypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ValueTypeDescriptorId: ").Append(ValueTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmValueTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmValueTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmValueTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmValueTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ValueTypeDescriptorId == input.ValueTypeDescriptorId ||
                    (this.ValueTypeDescriptorId != null &&
                    this.ValueTypeDescriptorId.Equals(input.ValueTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ValueTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.ValueTypeDescriptorId.GetHashCode();
