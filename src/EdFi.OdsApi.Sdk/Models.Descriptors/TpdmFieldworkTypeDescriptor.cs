...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmFieldworkTypeDescriptor :  IEquatable<TpdmFieldworkTypeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmFieldworkTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmFieldworkTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmFieldworkTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="fieldworkTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmFieldworkTypeDescriptor(string id = default(string), int? fieldworkTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmFieldworkTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmFieldworkTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmFieldworkTypeDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="fieldworkTypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FieldworkTypeDescriptorId: ").Append(FieldworkTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmFieldworkTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmFieldworkTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmFieldworkTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmFieldworkTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.FieldworkTypeDescriptorId == input.FieldworkTypeDescriptorId ||
                    (this.FieldworkTypeDescriptorId != null &&
                    this.FieldworkTypeDescriptorId.Equals(input.FieldworkTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FieldworkTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.FieldworkTypeDescriptorId.GetHashCode();
