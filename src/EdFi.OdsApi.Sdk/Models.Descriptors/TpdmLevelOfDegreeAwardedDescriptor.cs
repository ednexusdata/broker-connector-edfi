...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmLevelOfDegreeAwardedDescriptor :  IEquatable<TpdmLevelOfDegreeAwardedDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmLevelOfDegreeAwardedDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmLevelOfDegreeAwardedDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmLevelOfDegreeAwardedDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="levelOfDegreeAwardedDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmLevelOfDegreeAwardedDescriptor(string id = default(string), int? levelOfDegreeAwardedDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmLevelOfDegreeAwardedDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmLevelOfDegreeAwardedDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmLevelOfDegreeAwardedDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="levelOfDegreeAwardedDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LevelOfDegreeAwardedDescriptorId: ").Append(LevelOfDegreeAwardedDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmLevelOfDegreeAwardedDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmLevelOfDegreeAwardedDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmLevelOfDegreeAwardedDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmLevelOfDegreeAwardedDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.LevelOfDegreeAwardedDescriptorId == input.LevelOfDegreeAwardedDescriptorId ||
                    (this.LevelOfDegreeAwardedDescriptorId != null &&
                    this.LevelOfDegreeAwardedDescriptorId.Equals(input.LevelOfDegreeAwardedDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LevelOfDegreeAwardedDescriptorId != null)
                    hashCode = hashCode * 59 + this.LevelOfDegreeAwardedDescriptorId.GetHashCode();
