...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmOpenStaffPositionReasonDescriptor :  IEquatable<TpdmOpenStaffPositionReasonDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmOpenStaffPositionReasonDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmOpenStaffPositionReasonDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmOpenStaffPositionReasonDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="openStaffPositionReasonDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmOpenStaffPositionReasonDescriptor(string id = default(string), int? openStaffPositionReasonDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmOpenStaffPositionReasonDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmOpenStaffPositionReasonDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmOpenStaffPositionReasonDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="openStaffPositionReasonDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OpenStaffPositionReasonDescriptorId: ").Append(OpenStaffPositionReasonDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmOpenStaffPositionReasonDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmOpenStaffPositionReasonDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmOpenStaffPositionReasonDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmOpenStaffPositionReasonDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.OpenStaffPositionReasonDescriptorId == input.OpenStaffPositionReasonDescriptorId ||
                    (this.OpenStaffPositionReasonDescriptorId != null &&
                    this.OpenStaffPositionReasonDescriptorId.Equals(input.OpenStaffPositionReasonDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OpenStaffPositionReasonDescriptorId != null)
                    hashCode = hashCode * 59 + this.OpenStaffPositionReasonDescriptorId.GetHashCode();
