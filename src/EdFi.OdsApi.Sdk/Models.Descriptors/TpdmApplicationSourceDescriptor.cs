...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmApplicationSourceDescriptor :  IEquatable<TpdmApplicationSourceDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicationSourceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicationSourceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicationSourceDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="applicationSourceDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmApplicationSourceDescriptor(string id = default(string), int? applicationSourceDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmApplicationSourceDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmApplicationSourceDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="applicationSourceDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ApplicationSourceDescriptorId: ").Append(ApplicationSourceDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmApplicationSourceDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmApplicationSourceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicationSourceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicationSourceDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ApplicationSourceDescriptorId == input.ApplicationSourceDescriptorId ||
                    (this.ApplicationSourceDescriptorId != null &&
                    this.ApplicationSourceDescriptorId.Equals(input.ApplicationSourceDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ApplicationSourceDescriptorId != null)
                    hashCode = hashCode * 59 + this.ApplicationSourceDescriptorId.GetHashCode();
