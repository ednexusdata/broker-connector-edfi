...
{
    /// <summary>
    /// TpdmGoalTypeDescriptor
    /// </summary>
    [DataContract]
    public partial class TpdmGoalTypeDescriptor :  IEquatable<TpdmGoalTypeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmGoalTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmGoalTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmGoalTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="goalTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmGoalTypeDescriptor(string id = default(string), int? goalTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmGoalTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmGoalTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmGoalTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.GoalTypeDescriptorId = goalTypeDescriptorId;
        ...
        [DataMember(Name="goalTypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmGoalTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  GoalTypeDescriptorId: ").Append(GoalTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmGoalTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmGoalTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmGoalTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmGoalTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.GoalTypeDescriptorId == input.GoalTypeDescriptorId ||
                    (this.GoalTypeDescriptorId != null &&
                    this.GoalTypeDescriptorId.Equals(input.GoalTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.GoalTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.GoalTypeDescriptorId.GetHashCode();
