...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmCertificationExamStatusDescriptor :  IEquatable<TpdmCertificationExamStatusDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCertificationExamStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmCertificationExamStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCertificationExamStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="certificationExamStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmCertificationExamStatusDescriptor(string id = default(string), int? certificationExamStatusDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmCertificationExamStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmCertificationExamStatusDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="certificationExamStatusDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CertificationExamStatusDescriptorId: ").Append(CertificationExamStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmCertificationExamStatusDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmCertificationExamStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmCertificationExamStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmCertificationExamStatusDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CertificationExamStatusDescriptorId == input.CertificationExamStatusDescriptorId ||
                    (this.CertificationExamStatusDescriptorId != null &&
                    this.CertificationExamStatusDescriptorId.Equals(input.CertificationExamStatusDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CertificationExamStatusDescriptorId != null)
                    hashCode = hashCode * 59 + this.CertificationExamStatusDescriptorId.GetHashCode();
