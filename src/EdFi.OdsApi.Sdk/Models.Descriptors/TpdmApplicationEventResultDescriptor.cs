...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmApplicationEventResultDescriptor :  IEquatable<TpdmApplicationEventResultDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicationEventResultDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicationEventResultDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicationEventResultDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="applicationEventResultDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmApplicationEventResultDescriptor(string id = default(string), int? applicationEventResultDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmApplicationEventResultDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmApplicationEventResultDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmApplicationEventResultDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="applicationEventResultDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ApplicationEventResultDescriptorId: ").Append(ApplicationEventResultDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmApplicationEventResultDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmApplicationEventResultDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicationEventResultDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicationEventResultDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ApplicationEventResultDescriptorId == input.ApplicationEventResultDescriptorId ||
                    (this.ApplicationEventResultDescriptorId != null &&
                    this.ApplicationEventResultDescriptorId.Equals(input.ApplicationEventResultDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ApplicationEventResultDescriptorId != null)
                    hashCode = hashCode * 59 + this.ApplicationEventResultDescriptorId.GetHashCode();
