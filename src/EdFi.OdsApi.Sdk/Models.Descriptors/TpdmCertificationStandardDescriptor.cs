...
{
    /// <summary>
    /// TpdmCertificationStandardDescriptor
    /// </summary>
    [DataContract]
    public partial class TpdmCertificationStandardDescriptor :  IEquatable<TpdmCertificationStandardDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCertificationStandardDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmCertificationStandardDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCertificationStandardDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="certificationStandardDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmCertificationStandardDescriptor(string id = default(string), int? certificationStandardDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmCertificationStandardDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmCertificationStandardDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmCertificationStandardDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.CertificationStandardDescriptorId = certificationStandardDescriptorId;
        ...
        [DataMember(Name="certificationStandardDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmCertificationStandardDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  CertificationStandardDescriptorId: ").Append(CertificationStandardDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmCertificationStandardDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmCertificationStandardDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmCertificationStandardDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmCertificationStandardDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CertificationStandardDescriptorId == input.CertificationStandardDescriptorId ||
                    (this.CertificationStandardDescriptorId != null &&
                    this.CertificationStandardDescriptorId.Equals(input.CertificationStandardDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CertificationStandardDescriptorId != null)
                    hashCode = hashCode * 59 + this.CertificationStandardDescriptorId.GetHashCode();
