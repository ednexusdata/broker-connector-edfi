...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmSchoolStatusDescriptor :  IEquatable<TpdmSchoolStatusDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmSchoolStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmSchoolStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmSchoolStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="schoolStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmSchoolStatusDescriptor(string id = default(string), int? schoolStatusDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmSchoolStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmSchoolStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmSchoolStatusDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="schoolStatusDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SchoolStatusDescriptorId: ").Append(SchoolStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmSchoolStatusDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmSchoolStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmSchoolStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmSchoolStatusDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SchoolStatusDescriptorId == input.SchoolStatusDescriptorId ||
                    (this.SchoolStatusDescriptorId != null &&
                    this.SchoolStatusDescriptorId.Equals(input.SchoolStatusDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SchoolStatusDescriptorId != null)
                    hashCode = hashCode * 59 + this.SchoolStatusDescriptorId.GetHashCode();
