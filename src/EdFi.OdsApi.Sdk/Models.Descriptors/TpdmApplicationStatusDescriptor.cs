...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmApplicationStatusDescriptor :  IEquatable<TpdmApplicationStatusDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicationStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicationStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicationStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="applicationStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmApplicationStatusDescriptor(string id = default(string), int? applicationStatusDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmApplicationStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmApplicationStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmApplicationStatusDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="applicationStatusDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ApplicationStatusDescriptorId: ").Append(ApplicationStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmApplicationStatusDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmApplicationStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicationStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicationStatusDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ApplicationStatusDescriptorId == input.ApplicationStatusDescriptorId ||
                    (this.ApplicationStatusDescriptorId != null &&
                    this.ApplicationStatusDescriptorId.Equals(input.ApplicationStatusDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ApplicationStatusDescriptorId != null)
                    hashCode = hashCode * 59 + this.ApplicationStatusDescriptorId.GetHashCode();
