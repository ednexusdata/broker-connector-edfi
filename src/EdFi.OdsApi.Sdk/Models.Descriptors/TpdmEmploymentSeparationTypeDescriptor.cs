...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmEmploymentSeparationTypeDescriptor :  IEquatable<TpdmEmploymentSeparationTypeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEmploymentSeparationTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmEmploymentSeparationTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEmploymentSeparationTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="employmentSeparationTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmEmploymentSeparationTypeDescriptor(string id = default(string), int? employmentSeparationTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmEmploymentSeparationTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmEmploymentSeparationTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmEmploymentSeparationTypeDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="employmentSeparationTypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EmploymentSeparationTypeDescriptorId: ").Append(EmploymentSeparationTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmEmploymentSeparationTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmEmploymentSeparationTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmEmploymentSeparationTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmEmploymentSeparationTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.EmploymentSeparationTypeDescriptorId == input.EmploymentSeparationTypeDescriptorId ||
                    (this.EmploymentSeparationTypeDescriptorId != null &&
                    this.EmploymentSeparationTypeDescriptorId.Equals(input.EmploymentSeparationTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EmploymentSeparationTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.EmploymentSeparationTypeDescriptorId.GetHashCode();
