...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmHireStatusDescriptor :  IEquatable<TpdmHireStatusDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmHireStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmHireStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmHireStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="hireStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmHireStatusDescriptor(string id = default(string), int? hireStatusDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmHireStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmHireStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmHireStatusDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="hireStatusDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HireStatusDescriptorId: ").Append(HireStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmHireStatusDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmHireStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmHireStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmHireStatusDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.HireStatusDescriptorId == input.HireStatusDescriptorId ||
                    (this.HireStatusDescriptorId != null &&
                    this.HireStatusDescriptorId.Equals(input.HireStatusDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HireStatusDescriptorId != null)
                    hashCode = hashCode * 59 + this.HireStatusDescriptorId.GetHashCode();
