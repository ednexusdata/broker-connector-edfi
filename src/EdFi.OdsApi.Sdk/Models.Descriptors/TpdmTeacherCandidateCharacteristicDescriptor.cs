...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherCandidateCharacteristicDescriptor :  IEquatable<TpdmTeacherCandidateCharacteristicDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateCharacteristicDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherCandidateCharacteristicDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherCandidateCharacteristicDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="teacherCandidateCharacteristicDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmTeacherCandidateCharacteristicDescriptor(string id = default(string), int? teacherCandidateCharacteristicDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmTeacherCandidateCharacteristicDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmTeacherCandidateCharacteristicDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmTeacherCandidateCharacteristicDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="teacherCandidateCharacteristicDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TeacherCandidateCharacteristicDescriptorId: ").Append(TeacherCandidateCharacteristicDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmTeacherCandidateCharacteristicDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmTeacherCandidateCharacteristicDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherCandidateCharacteristicDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherCandidateCharacteristicDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TeacherCandidateCharacteristicDescriptorId == input.TeacherCandidateCharacteristicDescriptorId ||
                    (this.TeacherCandidateCharacteristicDescriptorId != null &&
                    this.TeacherCandidateCharacteristicDescriptorId.Equals(input.TeacherCandidateCharacteristicDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TeacherCandidateCharacteristicDescriptorId != null)
                    hashCode = hashCode * 59 + this.TeacherCandidateCharacteristicDescriptorId.GetHashCode();
