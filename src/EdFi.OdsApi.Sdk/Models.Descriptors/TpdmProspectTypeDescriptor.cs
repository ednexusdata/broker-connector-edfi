...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmProspectTypeDescriptor :  IEquatable<TpdmProspectTypeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmProspectTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmProspectTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmProspectTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="prospectTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmProspectTypeDescriptor(string id = default(string), int? prospectTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmProspectTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmProspectTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmProspectTypeDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="prospectTypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProspectTypeDescriptorId: ").Append(ProspectTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmProspectTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmProspectTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmProspectTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmProspectTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ProspectTypeDescriptorId == input.ProspectTypeDescriptorId ||
                    (this.ProspectTypeDescriptorId != null &&
                    this.ProspectTypeDescriptorId.Equals(input.ProspectTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ProspectTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.ProspectTypeDescriptorId.GetHashCode();
