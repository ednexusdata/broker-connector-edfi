...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmWithdrawReasonDescriptor :  IEquatable<TpdmWithdrawReasonDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmWithdrawReasonDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmWithdrawReasonDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmWithdrawReasonDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="withdrawReasonDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmWithdrawReasonDescriptor(string id = default(string), int? withdrawReasonDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmWithdrawReasonDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmWithdrawReasonDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmWithdrawReasonDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="withdrawReasonDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  WithdrawReasonDescriptorId: ").Append(WithdrawReasonDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmWithdrawReasonDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmWithdrawReasonDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmWithdrawReasonDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmWithdrawReasonDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.WithdrawReasonDescriptorId == input.WithdrawReasonDescriptorId ||
                    (this.WithdrawReasonDescriptorId != null &&
                    this.WithdrawReasonDescriptorId.Equals(input.WithdrawReasonDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WithdrawReasonDescriptorId != null)
                    hashCode = hashCode * 59 + this.WithdrawReasonDescriptorId.GetHashCode();
