...
{
    /// <summary>
    /// TpdmQuantitativeMeasureDatatypeDescriptor
    /// </summary>
    [DataContract]
    public partial class TpdmQuantitativeMeasureDatatypeDescriptor :  IEquatable<TpdmQuantitativeMeasureDatatypeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmQuantitativeMeasureDatatypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmQuantitativeMeasureDatatypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmQuantitativeMeasureDatatypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="quantitativeMeasureDatatypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmQuantitativeMeasureDatatypeDescriptor(string id = default(string), int? quantitativeMeasureDatatypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmQuantitativeMeasureDatatypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmQuantitativeMeasureDatatypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmQuantitativeMeasureDatatypeDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.QuantitativeMeasureDatatypeDescriptorId = quantitativeMeasureDatatypeDescriptorId;
        ...
        [DataMember(Name="quantitativeMeasureDatatypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmQuantitativeMeasureDatatypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  QuantitativeMeasureDatatypeDescriptorId: ").Append(QuantitativeMeasureDatatypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmQuantitativeMeasureDatatypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmQuantitativeMeasureDatatypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmQuantitativeMeasureDatatypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmQuantitativeMeasureDatatypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.QuantitativeMeasureDatatypeDescriptorId == input.QuantitativeMeasureDatatypeDescriptorId ||
                    (this.QuantitativeMeasureDatatypeDescriptorId != null &&
                    this.QuantitativeMeasureDatatypeDescriptorId.Equals(input.QuantitativeMeasureDatatypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.QuantitativeMeasureDatatypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.QuantitativeMeasureDatatypeDescriptorId.GetHashCode();
