...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmTeacherPreparationProgramTypeDescriptor :  IEquatable<TpdmTeacherPreparationProgramTypeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherPreparationProgramTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmTeacherPreparationProgramTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmTeacherPreparationProgramTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="teacherPreparationProgramTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmTeacherPreparationProgramTypeDescriptor(string id = default(string), int? teacherPreparationProgramTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmTeacherPreparationProgramTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmTeacherPreparationProgramTypeDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="teacherPreparationProgramTypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TeacherPreparationProgramTypeDescriptorId: ").Append(TeacherPreparationProgramTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmTeacherPreparationProgramTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmTeacherPreparationProgramTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmTeacherPreparationProgramTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmTeacherPreparationProgramTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TeacherPreparationProgramTypeDescriptorId == input.TeacherPreparationProgramTypeDescriptorId ||
                    (this.TeacherPreparationProgramTypeDescriptorId != null &&
                    this.TeacherPreparationProgramTypeDescriptorId.Equals(input.TeacherPreparationProgramTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TeacherPreparationProgramTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.TeacherPreparationProgramTypeDescriptorId.GetHashCode();
