...
{
    /// <summary>
    /// TpdmQuantitativeMeasureTypeDescriptor
    /// </summary>
    [DataContract]
    public partial class TpdmQuantitativeMeasureTypeDescriptor :  IEquatable<TpdmQuantitativeMeasureTypeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmQuantitativeMeasureTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmQuantitativeMeasureTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmQuantitativeMeasureTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="quantitativeMeasureTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmQuantitativeMeasureTypeDescriptor(string id = default(string), int? quantitativeMeasureTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmQuantitativeMeasureTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmQuantitativeMeasureTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmQuantitativeMeasureTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            this.QuantitativeMeasureTypeDescriptorId = quantitativeMeasureTypeDescriptorId;
        ...
        [DataMember(Name="quantitativeMeasureTypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmQuantitativeMeasureTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  QuantitativeMeasureTypeDescriptorId: ").Append(QuantitativeMeasureTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmQuantitativeMeasureTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmQuantitativeMeasureTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmQuantitativeMeasureTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmQuantitativeMeasureTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.QuantitativeMeasureTypeDescriptorId == input.QuantitativeMeasureTypeDescriptorId ||
                    (this.QuantitativeMeasureTypeDescriptorId != null &&
                    this.QuantitativeMeasureTypeDescriptorId.Equals(input.QuantitativeMeasureTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.QuantitativeMeasureTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.QuantitativeMeasureTypeDescriptorId.GetHashCode();
