...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmFundingSourceDescriptor :  IEquatable<TpdmFundingSourceDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmFundingSourceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmFundingSourceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmFundingSourceDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="fundingSourceDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmFundingSourceDescriptor(string id = default(string), int? fundingSourceDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmFundingSourceDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmFundingSourceDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmFundingSourceDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="fundingSourceDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FundingSourceDescriptorId: ").Append(FundingSourceDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmFundingSourceDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmFundingSourceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmFundingSourceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmFundingSourceDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.FundingSourceDescriptorId == input.FundingSourceDescriptorId ||
                    (this.FundingSourceDescriptorId != null &&
                    this.FundingSourceDescriptorId.Equals(input.FundingSourceDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FundingSourceDescriptorId != null)
                    hashCode = hashCode * 59 + this.FundingSourceDescriptorId.GetHashCode();
