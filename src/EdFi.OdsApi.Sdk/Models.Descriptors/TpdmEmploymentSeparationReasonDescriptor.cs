...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmEmploymentSeparationReasonDescriptor :  IEquatable<TpdmEmploymentSeparationReasonDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEmploymentSeparationReasonDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmEmploymentSeparationReasonDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEmploymentSeparationReasonDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="employmentSeparationReasonDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmEmploymentSeparationReasonDescriptor(string id = default(string), int? employmentSeparationReasonDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmEmploymentSeparationReasonDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmEmploymentSeparationReasonDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="employmentSeparationReasonDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EmploymentSeparationReasonDescriptorId: ").Append(EmploymentSeparationReasonDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmEmploymentSeparationReasonDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmEmploymentSeparationReasonDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmEmploymentSeparationReasonDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmEmploymentSeparationReasonDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.EmploymentSeparationReasonDescriptorId == input.EmploymentSeparationReasonDescriptorId ||
                    (this.EmploymentSeparationReasonDescriptorId != null &&
                    this.EmploymentSeparationReasonDescriptorId.Equals(input.EmploymentSeparationReasonDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EmploymentSeparationReasonDescriptorId != null)
                    hashCode = hashCode * 59 + this.EmploymentSeparationReasonDescriptorId.GetHashCode();
