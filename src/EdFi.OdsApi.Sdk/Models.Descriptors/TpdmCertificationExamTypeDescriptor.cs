...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmCertificationExamTypeDescriptor :  IEquatable<TpdmCertificationExamTypeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCertificationExamTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmCertificationExamTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCertificationExamTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="certificationExamTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmCertificationExamTypeDescriptor(string id = default(string), int? certificationExamTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmCertificationExamTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmCertificationExamTypeDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="certificationExamTypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CertificationExamTypeDescriptorId: ").Append(CertificationExamTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmCertificationExamTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmCertificationExamTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmCertificationExamTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmCertificationExamTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CertificationExamTypeDescriptorId == input.CertificationExamTypeDescriptorId ||
                    (this.CertificationExamTypeDescriptorId != null &&
                    this.CertificationExamTypeDescriptorId.Equals(input.CertificationExamTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CertificationExamTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.CertificationExamTypeDescriptorId.GetHashCode();
