...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmProgramGatewayDescriptor :  IEquatable<TpdmProgramGatewayDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmProgramGatewayDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmProgramGatewayDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmProgramGatewayDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="programGatewayDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmProgramGatewayDescriptor(string id = default(string), int? programGatewayDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmProgramGatewayDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmProgramGatewayDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmProgramGatewayDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="programGatewayDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProgramGatewayDescriptorId: ").Append(ProgramGatewayDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmProgramGatewayDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmProgramGatewayDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmProgramGatewayDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmProgramGatewayDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ProgramGatewayDescriptorId == input.ProgramGatewayDescriptorId ||
                    (this.ProgramGatewayDescriptorId != null &&
                    this.ProgramGatewayDescriptorId.Equals(input.ProgramGatewayDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ProgramGatewayDescriptorId != null)
                    hashCode = hashCode * 59 + this.ProgramGatewayDescriptorId.GetHashCode();
