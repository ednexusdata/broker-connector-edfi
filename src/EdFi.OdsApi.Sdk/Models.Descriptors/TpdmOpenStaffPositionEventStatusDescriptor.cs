...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmOpenStaffPositionEventStatusDescriptor :  IEquatable<TpdmOpenStaffPositionEventStatusDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmOpenStaffPositionEventStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmOpenStaffPositionEventStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmOpenStaffPositionEventStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="openStaffPositionEventStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmOpenStaffPositionEventStatusDescriptor(string id = default(string), int? openStaffPositionEventStatusDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmOpenStaffPositionEventStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmOpenStaffPositionEventStatusDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmOpenStaffPositionEventStatusDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="openStaffPositionEventStatusDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OpenStaffPositionEventStatusDescriptorId: ").Append(OpenStaffPositionEventStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmOpenStaffPositionEventStatusDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmOpenStaffPositionEventStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmOpenStaffPositionEventStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmOpenStaffPositionEventStatusDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.OpenStaffPositionEventStatusDescriptorId == input.OpenStaffPositionEventStatusDescriptorId ||
                    (this.OpenStaffPositionEventStatusDescriptorId != null &&
                    this.OpenStaffPositionEventStatusDescriptorId.Equals(input.OpenStaffPositionEventStatusDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OpenStaffPositionEventStatusDescriptorId != null)
                    hashCode = hashCode * 59 + this.OpenStaffPositionEventStatusDescriptorId.GetHashCode();
