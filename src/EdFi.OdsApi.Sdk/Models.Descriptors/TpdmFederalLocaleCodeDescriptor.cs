...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmFederalLocaleCodeDescriptor :  IEquatable<TpdmFederalLocaleCodeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmFederalLocaleCodeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmFederalLocaleCodeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmFederalLocaleCodeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="federalLocaleCodeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmFederalLocaleCodeDescriptor(string id = default(string), int? federalLocaleCodeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmFederalLocaleCodeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmFederalLocaleCodeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmFederalLocaleCodeDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="federalLocaleCodeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FederalLocaleCodeDescriptorId: ").Append(FederalLocaleCodeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmFederalLocaleCodeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmFederalLocaleCodeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmFederalLocaleCodeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmFederalLocaleCodeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.FederalLocaleCodeDescriptorId == input.FederalLocaleCodeDescriptorId ||
                    (this.FederalLocaleCodeDescriptorId != null &&
                    this.FederalLocaleCodeDescriptorId.Equals(input.FederalLocaleCodeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FederalLocaleCodeDescriptorId != null)
                    hashCode = hashCode * 59 + this.FederalLocaleCodeDescriptorId.GetHashCode();
