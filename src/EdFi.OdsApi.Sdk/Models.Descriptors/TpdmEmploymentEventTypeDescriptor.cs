...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmEmploymentEventTypeDescriptor :  IEquatable<TpdmEmploymentEventTypeDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEmploymentEventTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmEmploymentEventTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEmploymentEventTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="employmentEventTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmEmploymentEventTypeDescriptor(string id = default(string), int? employmentEventTypeDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new InvalidDataException("codeValue is a required property for TpdmEmploymentEventTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmEmploymentEventTypeDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmEmploymentEventTypeDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="employmentEventTypeDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EmploymentEventTypeDescriptorId: ").Append(EmploymentEventTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmEmploymentEventTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmEmploymentEventTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmEmploymentEventTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmEmploymentEventTypeDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.EmploymentEventTypeDescriptorId == input.EmploymentEventTypeDescriptorId ||
                    (this.EmploymentEventTypeDescriptorId != null &&
                    this.EmploymentEventTypeDescriptorId.Equals(input.EmploymentEventTypeDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EmploymentEventTypeDescriptorId != null)
                    hashCode = hashCode * 59 + this.EmploymentEventTypeDescriptorId.GetHashCode();
