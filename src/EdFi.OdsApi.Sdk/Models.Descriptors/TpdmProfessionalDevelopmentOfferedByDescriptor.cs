...
namespace EdFi.OdsApi.Sdk.Models.Descriptors
{
    ...
    /// </summary>
    [DataContract]
    public partial class TpdmProfessionalDevelopmentOfferedByDescriptor :  IEquatable<TpdmProfessionalDevelopmentOfferedByDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmProfessionalDevelopmentOfferedByDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmProfessionalDevelopmentOfferedByDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmProfessionalDevelopmentOfferedByDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="professionalDevelopmentOfferedByDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmProfessionalDevelopmentOfferedByDescriptor(string id = default(string), int? professionalDevelopmentOfferedByDescriptorId = default(int?), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for TpdmProfessionalDevelopmentOfferedByDescriptor and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortDescription is a required property for TpdmProfessionalDevelopmentOfferedByDescriptor and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="professionalDevelopmentOfferedByDescriptorId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProfessionalDevelopmentOfferedByDescriptorId: ").Append(ProfessionalDevelopmentOfferedByDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmProfessionalDevelopmentOfferedByDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmProfessionalDevelopmentOfferedByDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmProfessionalDevelopmentOfferedByDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmProfessionalDevelopmentOfferedByDescriptor input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ProfessionalDevelopmentOfferedByDescriptorId == input.ProfessionalDevelopmentOfferedByDescriptorId ||
                    (this.ProfessionalDevelopmentOfferedByDescriptorId != null &&
                    this.ProfessionalDevelopmentOfferedByDescriptorId.Equals(input.ProfessionalDevelopmentOfferedByDescriptorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ProfessionalDevelopmentOfferedByDescriptorId != null)
                    hashCode = hashCode * 59 + this.ProfessionalDevelopmentOfferedByDescriptorId.GetHashCode();
